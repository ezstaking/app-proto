...
export const GetRequest = {
  ...
  fromJSON(object: any): GetRequest {
    ...
    if (Array.isArray(object?.values))
      obj.values = object.values.map((e: any) => IndexValue.fromJSON(e));
    return obj;
  },
...
export const ListRequest = {
  ...
  fromJSON(object: any): ListRequest {
    ...
    if (isSet(object.prefix))
      obj.prefix = ListRequest_Prefix.fromJSON(object.prefix);
    if (isSet(object.range))
      obj.range = ListRequest_Range.fromJSON(object.range);
...
export const ListRequest_Range = {
  ...
  fromJSON(object: any): ListRequest_Range {
    ...
    if (Array.isArray(object?.start))
      obj.start = object.start.map((e: any) => IndexValue.fromJSON(e));
    if (Array.isArray(object?.end))
      obj.end = object.end.map((e: any) => IndexValue.fromJSON(e));
    return obj;
  },
...
export const ListResponse = {
  ...
  fromJSON(object: any): ListResponse {
    ...
    if (Array.isArray(object?.results))
      obj.results = object.results.map((e: any) => Any.fromJSON(e));
    if (isSet(object.pagination))
...
export const IndexValue = {
  ...
  fromJSON(object: any): IndexValue {
    ...
    if (isSet(object.duration))
      obj.duration = Duration.fromJSON(object.duration);
    return obj;
  },
