...
export const ModuleAccount = {
  ...
  fromJSON(object: any): ModuleAccount {
    ...
    if (Array.isArray(object?.permissions))
      obj.permissions = object.permissions.map((e: any) => String(e));
    return obj;
  },
...
export const ModuleCredential = {
  ...
  fromJSON(object: any): ModuleCredential {
    ...
    if (Array.isArray(object?.derivationKeys))
      obj.derivationKeys = object.derivationKeys.map((e: any) =>
        bytesFromBase64(e),
      );
    return obj;
  },
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.sigVerifyCostSecp256k1))
      obj.sigVerifyCostSecp256k1 = BigInt(
        object.sigVerifyCostSecp256k1.toString(),
      );
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    if (
      ...
      message.sigVerifyCostEd25519 = BigInt(
        object.sigVerifyCostEd25519.toString(),
      );
    }
    if (
      ...
      message.sigVerifyCostSecp256k1 = BigInt(
        object.sigVerifyCostSecp256k1.toString(),
      );
    }
    return message;
