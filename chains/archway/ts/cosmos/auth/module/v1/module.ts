...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    if (isSet(object.bech32Prefix))
      obj.bech32Prefix = String(object.bech32Prefix);
    if (Array.isArray(object?.moduleAccountPermissions))
      obj.moduleAccountPermissions = object.moduleAccountPermissions.map(
        (e: any) => ModuleAccountPermission.fromJSON(e),
      );
  ...
  toJSON(message: Module): JsonSafe<Module> {
    ...
    if (message.moduleAccountPermissions) {
      obj.moduleAccountPermissions = message.moduleAccountPermissions.map(
...
export const ModuleAccountPermission = {
  ...
  fromPartial<I extends Exact<DeepPartial<ModuleAccountPermission>, I>>(
    object: I,
  ): ModuleAccountPermission {
    const message = createBaseModuleAccountPermission();
