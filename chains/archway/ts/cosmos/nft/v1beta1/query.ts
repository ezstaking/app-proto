...
export const QueryNFTsResponse = {
  ...
  fromJSON(object: any): QueryNFTsResponse {
    ...
    if (Array.isArray(object?.nfts))
      obj.nfts = object.nfts.map((e: any) => NFT.fromJSON(e));
    if (isSet(object.pagination))
...
export const QueryClassesResponse = {
  ...
  fromJSON(object: any): QueryClassesResponse {
    ...
    if (Array.isArray(object?.classes))
      obj.classes = object.classes.map((e: any) => Class.fromJSON(e));
    if (isSet(object.pagination))
      obj.pagination = PageResponse.fromJSON(object.pagination);
    return obj;
  },
...
export class QueryClientImpl implements Query {
  ...
  Owner(request: QueryOwnerRequest): Promise<QueryOwnerResponse> {
    ...
    return promise.then((data) =>
      QueryOwnerResponse.decode(new BinaryReader(data)),
    );
  }
  Supply(request: QuerySupplyRequest): Promise<QuerySupplyResponse> {
    ...
    return promise.then((data) =>
      QuerySupplyResponse.decode(new BinaryReader(data)),
    );
  }
  NFTs(request: QueryNFTsRequest): Promise<QueryNFTsResponse> {
    ...
    return promise.then((data) =>
      QueryNFTsResponse.decode(new BinaryReader(data)),
    );
  }
  NFT(request: QueryNFTRequest): Promise<QueryNFTResponse> {
    ...
    return promise.then((data) =>
      QueryNFTResponse.decode(new BinaryReader(data)),
    );
  }
  Class(request: QueryClassRequest): Promise<QueryClassResponse> {
