...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.groupSeq))
      obj.groupSeq = BigInt(object.groupSeq.toString());
    if (Array.isArray(object?.groups))
      obj.groups = object.groups.map((e: any) => GroupInfo.fromJSON(e));
    if (Array.isArray(object?.groupMembers))
      obj.groupMembers = object.groupMembers.map((e: any) =>
        GroupMember.fromJSON(e),
      );
    if (isSet(object.groupPolicySeq))
      obj.groupPolicySeq = BigInt(object.groupPolicySeq.toString());
    if (Array.isArray(object?.groupPolicies))
      obj.groupPolicies = object.groupPolicies.map((e: any) =>
        GroupPolicyInfo.fromJSON(e),
      );
    if (isSet(object.proposalSeq))
