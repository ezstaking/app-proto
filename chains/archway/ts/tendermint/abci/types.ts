...
export const Request = {
  ...
  fromJSON(object: any): Request {
    ...
    if (isSet(object.initChain))
      obj.initChain = RequestInitChain.fromJSON(object.initChain);
    if (isSet(object.query)) obj.query = RequestQuery.fromJSON(object.query);
    if (isSet(object.beginBlock))
      obj.beginBlock = RequestBeginBlock.fromJSON(object.beginBlock);
    if (isSet(object.checkTx))
      obj.checkTx = RequestCheckTx.fromJSON(object.checkTx);
    if (isSet(object.deliverTx))
      obj.deliverTx = RequestDeliverTx.fromJSON(object.deliverTx);
    if (isSet(object.endBlock))
      obj.endBlock = RequestEndBlock.fromJSON(object.endBlock);
    if (isSet(object.commit))
      obj.commit = RequestCommit.fromJSON(object.commit);
    if (isSet(object.listSnapshots))
      obj.listSnapshots = RequestListSnapshots.fromJSON(object.listSnapshots);
    if (isSet(object.offerSnapshot))
      obj.offerSnapshot = RequestOfferSnapshot.fromJSON(object.offerSnapshot);
    if (isSet(object.loadSnapshotChunk))
      obj.loadSnapshotChunk = RequestLoadSnapshotChunk.fromJSON(
        object.loadSnapshotChunk,
      );
    if (isSet(object.applySnapshotChunk))
      obj.applySnapshotChunk = RequestApplySnapshotChunk.fromJSON(
        object.applySnapshotChunk,
      );
    if (isSet(object.prepareProposal))
      obj.prepareProposal = RequestPrepareProposal.fromJSON(
        object.prepareProposal,
      );
    if (isSet(object.processProposal))
      obj.processProposal = RequestProcessProposal.fromJSON(
...
export const RequestInfo = {
  ...
  fromJSON(object: any): RequestInfo {
    ...
    if (isSet(object.blockVersion))
      obj.blockVersion = BigInt(object.blockVersion.toString());
    if (isSet(object.p2pVersion))
...
export const RequestInitChain = {
  ...
  fromJSON(object: any): RequestInitChain {
    ...
    if (isSet(object.consensusParams))
      obj.consensusParams = ConsensusParams.fromJSON(object.consensusParams);
    if (Array.isArray(object?.validators))
      obj.validators = object.validators.map((e: any) =>
        ValidatorUpdate.fromJSON(e),
      );
    if (isSet(object.appStateBytes))
      obj.appStateBytes = bytesFromBase64(object.appStateBytes);
    if (isSet(object.initialHeight))
...
export const RequestBeginBlock = {
  ...
  fromJSON(object: any): RequestBeginBlock {
    ...
    if (isSet(object.lastCommitInfo))
      obj.lastCommitInfo = CommitInfo.fromJSON(object.lastCommitInfo);
    if (Array.isArray(object?.byzantineValidators))
      obj.byzantineValidators = object.byzantineValidators.map((e: any) =>
...
export const RequestOfferSnapshot = {
  ...
  fromJSON(object: any): RequestOfferSnapshot {
    ...
    if (isSet(object.snapshot))
      obj.snapshot = Snapshot.fromJSON(object.snapshot);
...
export const RequestPrepareProposal = {
  ...
  fromJSON(object: any): RequestPrepareProposal {
    ...
    if (Array.isArray(object?.misbehavior))
      obj.misbehavior = object.misbehavior.map((e: any) =>
        Misbehavior.fromJSON(e),
      );
    if (isSet(object.height)) obj.height = BigInt(object.height.toString());
    if (isSet(object.time)) obj.time = fromJsonTimestamp(object.time);
    if (isSet(object.nextValidatorsHash))
      obj.nextValidatorsHash = bytesFromBase64(object.nextValidatorsHash);
    if (isSet(object.proposerAddress))
      obj.proposerAddress = bytesFromBase64(object.proposerAddress);
    return obj;
  },
...
export const Response = {
  ...
  fromJSON(object: any): Response {
    ...
    if (isSet(object.exception))
      obj.exception = ResponseException.fromJSON(object.exception);
    ...
    if (isSet(object.initChain))
      obj.initChain = ResponseInitChain.fromJSON(object.initChain);
    if (isSet(object.query)) obj.query = ResponseQuery.fromJSON(object.query);
    if (isSet(object.beginBlock))
      obj.beginBlock = ResponseBeginBlock.fromJSON(object.beginBlock);
    if (isSet(object.checkTx))
      obj.checkTx = ResponseCheckTx.fromJSON(object.checkTx);
    if (isSet(object.deliverTx))
      obj.deliverTx = ResponseDeliverTx.fromJSON(object.deliverTx);
    if (isSet(object.endBlock))
      obj.endBlock = ResponseEndBlock.fromJSON(object.endBlock);
    if (isSet(object.commit))
      obj.commit = ResponseCommit.fromJSON(object.commit);
    if (isSet(object.listSnapshots))
      obj.listSnapshots = ResponseListSnapshots.fromJSON(object.listSnapshots);
    if (isSet(object.offerSnapshot))
      obj.offerSnapshot = ResponseOfferSnapshot.fromJSON(object.offerSnapshot);
    if (isSet(object.loadSnapshotChunk))
      obj.loadSnapshotChunk = ResponseLoadSnapshotChunk.fromJSON(
        object.loadSnapshotChunk,
      );
    if (isSet(object.applySnapshotChunk))
      obj.applySnapshotChunk = ResponseApplySnapshotChunk.fromJSON(
        object.applySnapshotChunk,
      );
    if (isSet(object.prepareProposal))
      obj.prepareProposal = ResponsePrepareProposal.fromJSON(
        object.prepareProposal,
      );
    if (isSet(object.processProposal))
      obj.processProposal = ResponseProcessProposal.fromJSON(
        object.processProposal,
      );
    return obj;
  },
...
export const ResponseInfo = {
  ...
  fromJSON(object: any): ResponseInfo {
    ...
    if (isSet(object.version)) obj.version = String(object.version);
    if (isSet(object.appVersion))
      obj.appVersion = BigInt(object.appVersion.toString());
    if (isSet(object.lastBlockHeight))
      obj.lastBlockHeight = BigInt(object.lastBlockHeight.toString());
    if (isSet(object.lastBlockAppHash))
      obj.lastBlockAppHash = bytesFromBase64(object.lastBlockAppHash);
    return obj;
  },
...
export const ResponseQuery = {
  ...
  fromJSON(object: any): ResponseQuery {
    ...
    if (isSet(object.proofOps))
      obj.proofOps = ProofOps.fromJSON(object.proofOps);
    if (isSet(object.height)) obj.height = BigInt(object.height.toString());
...
export const ResponseBeginBlock = {
  ...
  fromJSON(object: any): ResponseBeginBlock {
    ...
    if (Array.isArray(object?.events))
      obj.events = object.events.map((e: any) => Event.fromJSON(e));
    return obj;
  },
...
export const ResponseCheckTx = {
  ...
  fromJSON(object: any): ResponseCheckTx {
    ...
    if (isSet(object.log)) obj.log = String(object.log);
    if (isSet(object.info)) obj.info = String(object.info);
    if (isSet(object.gas_wanted))
      obj.gasWanted = BigInt(object.gas_wanted.toString());
    if (isSet(object.gas_used))
...
export const ResponseEndBlock = {
  ...
  fromJSON(object: any): ResponseEndBlock {
    ...
    if (Array.isArray(object?.validatorUpdates))
      obj.validatorUpdates = object.validatorUpdates.map((e: any) =>
        ValidatorUpdate.fromJSON(e),
      );
    if (isSet(object.consensusParamUpdates))
      obj.consensusParamUpdates = ConsensusParams.fromJSON(
...
export const ResponseProcessProposal = {
  ...
  fromJSON(object: any): ResponseProcessProposal {
    ...
    if (isSet(object.status))
      obj.status = responseProcessProposal_ProposalStatusFromJSON(
        object.status,
      );
    return obj;
  },
...
export const CommitInfo = {
  ...
  fromJSON(object: any): CommitInfo {
    ...
    if (Array.isArray(object?.votes))
      obj.votes = object.votes.map((e: any) => VoteInfo.fromJSON(e));
    return obj;
  },
...
export const ExtendedCommitInfo = {
  ...
  fromJSON(object: any): ExtendedCommitInfo {
    ...
    if (isSet(object.round)) obj.round = Number(object.round);
    if (Array.isArray(object?.votes))
      obj.votes = object.votes.map((e: any) => ExtendedVoteInfo.fromJSON(e));
    return obj;
  },
...
export const Event = {
  ...
  fromJSON(object: any): Event {
    ...
    if (Array.isArray(object?.attributes))
      obj.attributes = object.attributes.map((e: any) =>
...
export const TxResult = {
  ...
  fromJSON(object: any): TxResult {
    ...
    if (isSet(object.tx)) obj.tx = bytesFromBase64(object.tx);
    if (isSet(object.result))
      obj.result = ResponseDeliverTx.fromJSON(object.result);
    return obj;
  },
...
export const VoteInfo = {
  ...
  fromJSON(object: any): VoteInfo {
    ...
    if (isSet(object.validator))
      obj.validator = Validator.fromJSON(object.validator);
    if (isSet(object.signedLastBlock))
...
export const ExtendedVoteInfo = {
  ...
  fromJSON(object: any): ExtendedVoteInfo {
    ...
    if (isSet(object.signedLastBlock))
      obj.signedLastBlock = Boolean(object.signedLastBlock);
    if (isSet(object.voteExtension))
      obj.voteExtension = bytesFromBase64(object.voteExtension);
    return obj;
  },
...
export const Misbehavior = {
  ...
  fromJSON(object: any): Misbehavior {
    ...
    if (isSet(object.height)) obj.height = BigInt(object.height.toString());
    if (isSet(object.time)) obj.time = fromJsonTimestamp(object.time);
    if (isSet(object.totalVotingPower))
...
export class ABCIApplicationClientImpl implements ABCIApplication {
  ...
  DeliverTx(request: RequestDeliverTx): Promise<ResponseDeliverTx> {
    ...
    return promise.then((data) =>
      ResponseDeliverTx.decode(new BinaryReader(data)),
    );
  }
  CheckTx(request: RequestCheckTx): Promise<ResponseCheckTx> {
    ...
    return promise.then((data) =>
      ResponseCheckTx.decode(new BinaryReader(data)),
    );
  }
  Query(request: RequestQuery): Promise<ResponseQuery> {
  ...
  Commit(request: RequestCommit = {}): Promise<ResponseCommit> {
    ...
    return promise.then((data) =>
      ResponseCommit.decode(new BinaryReader(data)),
    );
  }
  InitChain(request: RequestInitChain): Promise<ResponseInitChain> {
    ...
    return promise.then((data) =>
      ResponseInitChain.decode(new BinaryReader(data)),
    );
  }
  BeginBlock(request: RequestBeginBlock): Promise<ResponseBeginBlock> {
    ...
    return promise.then((data) =>
      ResponseBeginBlock.decode(new BinaryReader(data)),
    );
  }
  EndBlock(request: RequestEndBlock): Promise<ResponseEndBlock> {
    ...
    return promise.then((data) =>
      ResponseEndBlock.decode(new BinaryReader(data)),
    );
  }
  ListSnapshots(
    ...
    return promise.then((data) =>
      ResponseListSnapshots.decode(new BinaryReader(data)),
    );
  }
  OfferSnapshot(request: RequestOfferSnapshot): Promise<ResponseOfferSnapshot> {
    ...
    return promise.then((data) =>
      ResponseOfferSnapshot.decode(new BinaryReader(data)),
    );
  }
  LoadSnapshotChunk(
    request: RequestLoadSnapshotChunk,
    ...
    return promise.then((data) =>
      ResponseLoadSnapshotChunk.decode(new BinaryReader(data)),
    );
  }
  ApplySnapshotChunk(
    request: RequestApplySnapshotChunk,
    ...
    return promise.then((data) =>
      ResponseApplySnapshotChunk.decode(new BinaryReader(data)),
    );
  }
  PrepareProposal(
    request: RequestPrepareProposal,
    ...
    return promise.then((data) =>
      ResponsePrepareProposal.decode(new BinaryReader(data)),
    );
  }
  ProcessProposal(
    request: RequestProcessProposal,
    ...
    return promise.then((data) =>
      ResponseProcessProposal.decode(new BinaryReader(data)),
    );
  }
}
