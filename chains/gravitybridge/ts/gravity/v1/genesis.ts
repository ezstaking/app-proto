...
import { Valset, ERC20ToDenom, PendingIbcAutoForward } from "./types";
import {
  MsgValsetConfirm,
  MsgConfirmBatch,
  MsgConfirmLogicCall,
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.contractSourceHash))
      obj.contractSourceHash = String(object.contractSourceHash);
    if (isSet(object.bridgeEthereumAddress))
      obj.bridgeEthereumAddress = String(object.bridgeEthereumAddress);
    if (isSet(object.bridgeChainId))
      obj.bridgeChainId = BigInt(object.bridgeChainId.toString());
    ...
    if (isSet(object.signedLogicCallsWindow))
      obj.signedLogicCallsWindow = BigInt(
        object.signedLogicCallsWindow.toString(),
      );
    if (isSet(object.targetBatchTimeout))
      obj.targetBatchTimeout = BigInt(object.targetBatchTimeout.toString());
    if (isSet(object.averageBlockTime))
      obj.averageBlockTime = BigInt(object.averageBlockTime.toString());
    if (isSet(object.averageEthereumBlockTime))
      obj.averageEthereumBlockTime = BigInt(
        object.averageEthereumBlockTime.toString(),
      );
    if (isSet(object.slashFractionValset))
      obj.slashFractionValset = bytesFromBase64(object.slashFractionValset);
    if (isSet(object.slashFractionBatch))
      obj.slashFractionBatch = bytesFromBase64(object.slashFractionBatch);
    if (isSet(object.slashFractionLogicCall))
      obj.slashFractionLogicCall = bytesFromBase64(
        object.slashFractionLogicCall,
      );
    if (isSet(object.unbondSlashingValsetsWindow))
      obj.unbondSlashingValsetsWindow = BigInt(
        object.unbondSlashingValsetsWindow.toString(),
      );
    if (isSet(object.slashFractionBadEthSignature))
      obj.slashFractionBadEthSignature = bytesFromBase64(
        object.slashFractionBadEthSignature,
      );
    if (isSet(object.valsetReward))
      obj.valsetReward = Coin.fromJSON(object.valsetReward);
    if (isSet(object.bridgeActive))
      obj.bridgeActive = Boolean(object.bridgeActive);
    if (Array.isArray(object?.ethereumBlacklist))
      obj.ethereumBlacklist = object.ethereumBlacklist.map((e: any) =>
        String(e),
      );
    if (isSet(object.minChainFeeBasisPoints))
      obj.minChainFeeBasisPoints = BigInt(
        object.minChainFeeBasisPoints.toString(),
      );
    if (isSet(object.chainFeeAuctionPoolFraction))
      obj.chainFeeAuctionPoolFraction = String(
        object.chainFeeAuctionPoolFraction,
      );
    return obj;
  },
  toJSON(message: Params): JsonSafe<Params> {
    ...
    message.chainFeeAuctionPoolFraction !== undefined &&
      (obj.chainFeeAuctionPoolFraction = message.chainFeeAuctionPoolFraction);
    return obj;
  },
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    if (
      ...
      message.signedValsetsWindow = BigInt(
        object.signedValsetsWindow.toString(),
      );
    }
    if (
      ...
      message.signedBatchesWindow = BigInt(
        object.signedBatchesWindow.toString(),
      );
    }
    if (
      ...
      message.signedLogicCallsWindow = BigInt(
        object.signedLogicCallsWindow.toString(),
      );
    }
    if (
    ...
    if (
      ...
      message.averageEthereumBlockTime = BigInt(
        object.averageEthereumBlockTime.toString(),
      );
    }
    message.slashFractionValset =
    ...
    if (
      ...
      message.unbondSlashingValsetsWindow = BigInt(
        object.unbondSlashingValsetsWindow.toString(),
      );
    }
    message.slashFractionBadEthSignature =
    ...
    if (
      ...
      message.minChainFeeBasisPoints = BigInt(
        object.minChainFeeBasisPoints.toString(),
      );
    }
    message.chainFeeAuctionPoolFraction =
      object.chainFeeAuctionPoolFraction ?? "";
    return message;
  },
};
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.gravityNonces))
      obj.gravityNonces = GravityNonces.fromJSON(object.gravityNonces);
    ...
    if (Array.isArray(object?.valsetConfirms))
      obj.valsetConfirms = object.valsetConfirms.map((e: any) =>
    ...
    if (Array.isArray(object?.batchConfirms))
      obj.batchConfirms = object.batchConfirms.map((e: any) =>
        MsgConfirmBatch.fromJSON(e),
      );
    if (Array.isArray(object?.logicCalls))
      obj.logicCalls = object.logicCalls.map((e: any) =>
        OutgoingLogicCall.fromJSON(e),
      );
    if (Array.isArray(object?.logicCallConfirms))
      obj.logicCallConfirms = object.logicCallConfirms.map((e: any) =>
    ...
    if (Array.isArray(object?.delegateKeys))
      obj.delegateKeys = object.delegateKeys.map((e: any) =>
        MsgSetOrchestratorAddress.fromJSON(e),
      );
    if (Array.isArray(object?.erc20ToDenoms))
      obj.erc20ToDenoms = object.erc20ToDenoms.map((e: any) =>
...
export const GravityNonces = {
  ...
  fromJSON(object: any): GravityNonces {
    ...
    if (isSet(object.latestValsetNonce))
      obj.latestValsetNonce = BigInt(object.latestValsetNonce.toString());
    if (isSet(object.lastObservedNonce))
      obj.lastObservedNonce = BigInt(object.lastObservedNonce.toString());
    if (isSet(object.lastSlashedValsetNonce))
      obj.lastSlashedValsetNonce = BigInt(
        object.lastSlashedValsetNonce.toString(),
      );
    if (isSet(object.lastSlashedBatchBlock))
      obj.lastSlashedBatchBlock = BigInt(
        object.lastSlashedBatchBlock.toString(),
      );
    if (isSet(object.lastSlashedLogicCallBlock))
      obj.lastSlashedLogicCallBlock = BigInt(
        object.lastSlashedLogicCallBlock.toString(),
      );
    if (isSet(object.lastTxPoolId))
      obj.lastTxPoolId = BigInt(object.lastTxPoolId.toString());
    if (isSet(object.lastBatchId))
      obj.lastBatchId = BigInt(object.lastBatchId.toString());
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GravityNonces>, I>>(
    ...
    if (
      ...
      message.lastSlashedValsetNonce = BigInt(
        object.lastSlashedValsetNonce.toString(),
      );
    }
    if (
      ...
      message.lastSlashedBatchBlock = BigInt(
        object.lastSlashedBatchBlock.toString(),
      );
    }
    if (
      ...
      message.lastSlashedLogicCallBlock = BigInt(
        object.lastSlashedLogicCallBlock.toString(),
      );
    }
