...
export const BlockParams = {
  ...
  fromJSON(object: any): BlockParams {
    ...
    if (isSet(object.timeIotaMs))
      obj.timeIotaMs = BigInt(object.timeIotaMs.toString());
    return obj;
  },
...
export const EvidenceParams = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.proofTrialPeriod = reader.int64();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): EvidenceParams {
    ...
    if (isSet(object.maxAgeNumBlocks))
      obj.maxAgeNumBlocks = BigInt(object.maxAgeNumBlocks.toString());
    if (isSet(object.maxAgeDuration))
      obj.maxAgeDuration = Duration.fromJSON(object.maxAgeDuration);
    if (isSet(object.maxNum)) obj.maxNum = Number(object.maxNum);
    if (isSet(object.proofTrialPeriod))
      obj.proofTrialPeriod = BigInt(object.proofTrialPeriod.toString());
    return obj;
  },
  toJSON(message: EvidenceParams): JsonSafe<EvidenceParams> {
    ...
    message.maxAgeDuration !== undefined &&
      (obj.maxAgeDuration = message.maxAgeDuration
        ...
        : undefined);
    message.maxNum !== undefined && (obj.maxNum = Math.round(message.maxNum));
    message.proofTrialPeriod !== undefined &&
      (obj.proofTrialPeriod = (
        message.proofTrialPeriod || BigInt(0)
      ).toString());
    return obj;
  },
  fromPartial<I extends Exact<DeepPartial<EvidenceParams>, I>>(
    ...
    if (
      object.proofTrialPeriod !== undefined &&
      object.proofTrialPeriod !== null
    ) {
      message.proofTrialPeriod = BigInt(object.proofTrialPeriod.toString());
    }
    return message;
  },
};
...
export const ValidatorParams = {
  ...
  fromJSON(object: any): ValidatorParams {
    ...
    if (Array.isArray(object?.pubKeyTypes))
      obj.pubKeyTypes = object.pubKeyTypes.map((e: any) => String(e));
    return obj;
  },
