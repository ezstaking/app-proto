...
export const ConnectionEnd = {
  ...
  fromJSON(object: any): ConnectionEnd {
    ...
    if (Array.isArray(object?.versions))
      obj.versions = object.versions.map((e: any) => Version.fromJSON(e));
...
export const ClientPaths = {
  ...
  fromJSON(object: any): ClientPaths {
    ...
    if (Array.isArray(object?.paths))
      obj.paths = object.paths.map((e: any) => String(e));
    return obj;
  },
...
export const Version = {
  ...
  fromJSON(object: any): Version {
    ...
    if (Array.isArray(object?.features))
      obj.features = object.features.map((e: any) => String(e));
    return obj;
  },
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.maxExpectedTimePerBlock))
      obj.maxExpectedTimePerBlock = BigInt(
        object.maxExpectedTimePerBlock.toString(),
      );
    return obj;
  },
