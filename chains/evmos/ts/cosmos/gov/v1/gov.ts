...
export const Proposal = {
  ...
  fromJSON(object: any): Proposal {
    ...
    if (isSet(object.finalTallyResult))
      obj.finalTallyResult = TallyResult.fromJSON(object.finalTallyResult);
    if (isSet(object.submitTime))
      obj.submitTime = fromJsonTimestamp(object.submitTime);
    if (isSet(object.depositEndTime))
      obj.depositEndTime = fromJsonTimestamp(object.depositEndTime);
    if (Array.isArray(object?.totalDeposit))
      obj.totalDeposit = object.totalDeposit.map((e: any) => Coin.fromJSON(e));
    if (isSet(object.votingStartTime))
      obj.votingStartTime = fromJsonTimestamp(object.votingStartTime);
    if (isSet(object.votingEndTime))
...
export const Vote = {
  ...
  fromJSON(object: any): Vote {
    ...
    if (Array.isArray(object?.options))
      obj.options = object.options.map((e: any) =>
...
export const DepositParams = {
  ...
  fromJSON(object: any): DepositParams {
    ...
    if (isSet(object.maxDepositPeriod))
      obj.maxDepositPeriod = Duration.fromJSON(object.maxDepositPeriod);
    return obj;
  },
...
export const VotingParams = {
  ...
  fromJSON(object: any): VotingParams {
    ...
    if (isSet(object.votingPeriod))
      obj.votingPeriod = Duration.fromJSON(object.votingPeriod);
    return obj;
  },
