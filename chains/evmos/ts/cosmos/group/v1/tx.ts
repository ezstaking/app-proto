...
export const MsgUpdateGroupMembers = {
  ...
  fromJSON(object: any): MsgUpdateGroupMembers {
    ...
    if (Array.isArray(object?.memberUpdates))
      obj.memberUpdates = object.memberUpdates.map((e: any) =>
...
export const MsgExecResponse = {
  ...
  fromJSON(object: any): MsgExecResponse {
    ...
    if (isSet(object.result))
      obj.result = proposalExecutorResultFromJSON(object.result);
    return obj;
  },
...
export class MsgClientImpl implements Msg {
  ...
  Exec(request: MsgExec): Promise<MsgExecResponse> {
    ...
    return promise.then((data) =>
      MsgExecResponse.decode(new BinaryReader(data)),
    );
  }
  LeaveGroup(request: MsgLeaveGroup): Promise<MsgLeaveGroupResponse> {
