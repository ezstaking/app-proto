...
export const QuerySigningInfoResponse = {
  ...
  toJSON(
    message: QuerySigningInfoResponse,
  ): JsonSafe<QuerySigningInfoResponse> {
    const obj: any = {};
...
export const QuerySigningInfosRequest = {
  ...
  toJSON(
    message: QuerySigningInfosRequest,
  ): JsonSafe<QuerySigningInfosRequest> {
    const obj: any = {};
...
export const QuerySigningInfosResponse = {
  ...
  fromJSON(object: any): QuerySigningInfosResponse {
    ...
    if (Array.isArray(object?.info))
      obj.info = object.info.map((e: any) => ValidatorSigningInfo.fromJSON(e));
    if (isSet(object.pagination))
  ...
  toJSON(
    message: QuerySigningInfosResponse,
  ): JsonSafe<QuerySigningInfosResponse> {
    const obj: any = {};
    if (message.info) {
