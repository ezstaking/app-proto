...
export const PeriodicAllowance = {
  ...
  fromJSON(object: any): PeriodicAllowance {
    ...
    if (Array.isArray(object?.periodSpendLimit))
      obj.periodSpendLimit = object.periodSpendLimit.map((e: any) =>
        Coin.fromJSON(e),
      );
    if (Array.isArray(object?.periodCanSpend))
      obj.periodCanSpend = object.periodCanSpend.map((e: any) =>
        Coin.fromJSON(e),
      );
    if (isSet(object.periodReset))
      obj.periodReset = fromJsonTimestamp(object.periodReset);
    return obj;
  },
