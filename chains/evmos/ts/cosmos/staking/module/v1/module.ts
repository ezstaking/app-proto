...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    if (Array.isArray(object?.hooksOrder))
      obj.hooksOrder = object.hooksOrder.map((e: any) => String(e));
    if (isSet(object.authority)) obj.authority = String(object.authority);
    if (isSet(object.bech32PrefixValidator))
      obj.bech32PrefixValidator = String(object.bech32PrefixValidator);
    if (isSet(object.bech32PrefixConsensus))
      obj.bech32PrefixConsensus = String(object.bech32PrefixConsensus);
    return obj;
  },
