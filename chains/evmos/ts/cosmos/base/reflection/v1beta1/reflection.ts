...
export const ListAllInterfacesResponse = {
  ...
  toJSON(
    message: ListAllInterfacesResponse,
  ): JsonSafe<ListAllInterfacesResponse> {
    const obj: any = {};
...
export const ListImplementationsRequest = {
  ...
  fromJSON(object: any): ListImplementationsRequest {
    ...
    if (isSet(object.interfaceName))
      obj.interfaceName = String(object.interfaceName);
    return obj;
  },
  toJSON(
    message: ListImplementationsRequest,
  ): JsonSafe<ListImplementationsRequest> {
    const obj: any = {};
...
export const ListImplementationsResponse = {
  ...
  fromJSON(object: any): ListImplementationsResponse {
    ...
    if (Array.isArray(object?.implementationMessageNames))
      obj.implementationMessageNames = object.implementationMessageNames.map(
        (e: any) => String(e),
      );
    return obj;
  },
  toJSON(
    message: ListImplementationsResponse,
  ): JsonSafe<ListImplementationsResponse> {
    const obj: any = {};
...
export class ReflectionServiceClientImpl implements ReflectionService {
  ...
  ListAllInterfaces(
    ...
    return promise.then((data) =>
      ListAllInterfacesResponse.decode(new BinaryReader(data)),
    );
  }
  ListImplementations(
    request: ListImplementationsRequest,
    ...
    return promise.then((data) =>
      ListImplementationsResponse.decode(new BinaryReader(data)),
    );
  }
}
