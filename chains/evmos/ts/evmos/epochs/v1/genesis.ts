...
export const EpochInfo = {
  ...
  fromJSON(object: any): EpochInfo {
    ...
    if (isSet(object.currentEpochStartTime))
      obj.currentEpochStartTime = fromJsonTimestamp(
        object.currentEpochStartTime,
      );
    if (isSet(object.epochCountingStarted))
      obj.epochCountingStarted = Boolean(object.epochCountingStarted);
    if (isSet(object.currentEpochStartHeight))
      obj.currentEpochStartHeight = BigInt(
        object.currentEpochStartHeight.toString(),
      );
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EpochInfo>, I>>(
    ...
    if (
      ...
      message.currentEpochStartTime = Timestamp.fromPartial(
        object.currentEpochStartTime,
      );
    }
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.epochs))
      obj.epochs = object.epochs.map((e: any) => EpochInfo.fromJSON(e));
    return obj;
  },
