...
export interface TokenPair {
  ...
  enabled: boolean;
  /** contract_owner is an ENUM specifying the type of ERC20 owner (0 invalid, 1 ModuleAccount, 2 external address) */
  contractOwner: Owner;
}
/**
...
export const RegisterCoinProposal = {
  ...
  fromJSON(object: any): RegisterCoinProposal {
    ...
    if (Array.isArray(object?.metadata))
      obj.metadata = object.metadata.map((e: any) => Metadata.fromJSON(e));
    return obj;
  },
...
export const ProposalMetadata = {
  ...
  fromPartial<I extends Exact<DeepPartial<ProposalMetadata>, I>>(
    object: I,
  ): ProposalMetadata {
    const message = createBaseProposalMetadata();
    message.metadata =
...
export const ToggleTokenConversionProposal = {
  ...
  toJSON(
    message: ToggleTokenConversionProposal,
  ): JsonSafe<ToggleTokenConversionProposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined &&
      (obj.description = message.description);
