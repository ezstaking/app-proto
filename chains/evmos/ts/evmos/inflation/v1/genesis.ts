...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.epochIdentifier))
      obj.epochIdentifier = String(object.epochIdentifier);
    if (isSet(object.epochsPerPeriod))
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      object.epochsPerPeriod !== undefined &&
      object.epochsPerPeriod !== null
    ) {
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.exponentialCalculation))
      obj.exponentialCalculation = ExponentialCalculation.fromJSON(
        object.exponentialCalculation,
      );
    if (isSet(object.inflationDistribution))
      obj.inflationDistribution = InflationDistribution.fromJSON(
        object.inflationDistribution,
      );
    if (isSet(object.enableInflation))
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    if (
      ...
      message.exponentialCalculation = ExponentialCalculation.fromPartial(
        object.exponentialCalculation,
      );
    }
    if (
      ...
      message.inflationDistribution = InflationDistribution.fromPartial(
        object.inflationDistribution,
      );
    }
