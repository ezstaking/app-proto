...
export const QueryEpochMintProvisionRequest = {
  ...
  toJSON(
    _: QueryEpochMintProvisionRequest,
  ): JsonSafe<QueryEpochMintProvisionRequest> {
    const obj: any = {};
    return obj;
  },
...
export const QueryEpochMintProvisionResponse = {
  ...
  toJSON(
    message: QueryEpochMintProvisionResponse,
  ): JsonSafe<QueryEpochMintProvisionResponse> {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<QueryEpochMintProvisionResponse>, I>>(
    ...
    if (
      ...
      message.epochMintProvision = DecCoin.fromPartial(
        object.epochMintProvision,
      );
    }
    return message;
  },
...
export const QuerySkippedEpochsResponse = {
  ...
  fromJSON(object: any): QuerySkippedEpochsResponse {
    ...
    if (isSet(object.skippedEpochs))
      obj.skippedEpochs = BigInt(object.skippedEpochs.toString());
    return obj;
  },
  toJSON(
    message: QuerySkippedEpochsResponse,
  ): JsonSafe<QuerySkippedEpochsResponse> {
    const obj: any = {};
...
export const QueryCirculatingSupplyRequest = {
  ...
  toJSON(
    _: QueryCirculatingSupplyRequest,
  ): JsonSafe<QueryCirculatingSupplyRequest> {
    const obj: any = {};
    return obj;
  },
...
export const QueryCirculatingSupplyResponse = {
  ...
  fromJSON(object: any): QueryCirculatingSupplyResponse {
    ...
    if (isSet(object.circulatingSupply))
      obj.circulatingSupply = DecCoin.fromJSON(object.circulatingSupply);
    return obj;
  },
  toJSON(
    message: QueryCirculatingSupplyResponse,
  ): JsonSafe<QueryCirculatingSupplyResponse> {
    const obj: any = {};
...
export const QueryInflationRateResponse = {
  ...
  fromJSON(object: any): QueryInflationRateResponse {
    ...
    if (isSet(object.inflationRate))
      obj.inflationRate = String(object.inflationRate);
    return obj;
  },
  toJSON(
    message: QueryInflationRateResponse,
  ): JsonSafe<QueryInflationRateResponse> {
    const obj: any = {};
...
export class QueryClientImpl implements Query {
  ...
  Period(request: QueryPeriodRequest = {}): Promise<QueryPeriodResponse> {
    ...
    const promise = this.rpc.request(
      "evmos.inflation.v1.Query",
      "Period",
      data,
    );
    return promise.then((data) =>
      QueryPeriodResponse.decode(new BinaryReader(data)),
    );
  }
  EpochMintProvision(
    request: QueryEpochMintProvisionRequest = {},
    ...
    return promise.then((data) =>
      QueryEpochMintProvisionResponse.decode(new BinaryReader(data)),
    );
  }
  SkippedEpochs(
    request: QuerySkippedEpochsRequest = {},
    ...
    return promise.then((data) =>
      QuerySkippedEpochsResponse.decode(new BinaryReader(data)),
    );
  }
  CirculatingSupply(
    request: QueryCirculatingSupplyRequest = {},
  ...
  InflationRate(
    ...
    return promise.then((data) =>
      QueryInflationRateResponse.decode(new BinaryReader(data)),
    );
  }
  Params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
