...
export const EventCreateClawbackVestingAccount = {
  ...
  fromJSON(object: any): EventCreateClawbackVestingAccount {
    ...
    if (isSet(object.vestingAccount))
      obj.vestingAccount = String(object.vestingAccount);
    return obj;
  },
  toJSON(
    message: EventCreateClawbackVestingAccount,
  ): JsonSafe<EventCreateClawbackVestingAccount> {
    const obj: any = {};
  ...
  fromPartial<
    I extends Exact<DeepPartial<EventCreateClawbackVestingAccount>, I>,
  >(object: I): EventCreateClawbackVestingAccount {
    const message = createBaseEventCreateClawbackVestingAccount();
...
export const EventFundVestingAccount = {
  ...
  fromPartial<I extends Exact<DeepPartial<EventFundVestingAccount>, I>>(
    object: I,
  ): EventFundVestingAccount {
    const message = createBaseEventFundVestingAccount();
    message.funder = object.funder ?? "";
...
export const EventClawback = {
  ...
  fromPartial<I extends Exact<DeepPartial<EventClawback>, I>>(
    object: I,
  ): EventClawback {
    const message = createBaseEventClawback();
    message.funder = object.funder ?? "";
...
export const EventUpdateVestingFunder = {
  ...
  toJSON(
    message: EventUpdateVestingFunder,
  ): JsonSafe<EventUpdateVestingFunder> {
    const obj: any = {};
    message.funder !== undefined && (obj.funder = message.funder);
    message.account !== undefined && (obj.account = message.account);
