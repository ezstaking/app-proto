...
export const QueryBalancesResponse = {
  ...
  fromJSON(object: any): QueryBalancesResponse {
    ...
    if (Array.isArray(object?.locked))
      obj.locked = object.locked.map((e: any) => Coin.fromJSON(e));
    if (Array.isArray(object?.unvested))
      obj.unvested = object.unvested.map((e: any) => Coin.fromJSON(e));
    if (Array.isArray(object?.vested))
      obj.vested = object.vested.map((e: any) => Coin.fromJSON(e));
    return obj;
  },
