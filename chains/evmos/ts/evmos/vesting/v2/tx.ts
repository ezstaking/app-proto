...
export const MsgCreateClawbackVestingAccount = {
  ...
  fromJSON(object: any): MsgCreateClawbackVestingAccount {
    ...
    if (isSet(object.funderAddress))
      obj.funderAddress = String(object.funderAddress);
    if (isSet(object.vestingAddress))
      obj.vestingAddress = String(object.vestingAddress);
    if (isSet(object.enableGovClawback))
  ...
  toJSON(
    ...
    message.vestingAddress !== undefined &&
      (obj.vestingAddress = message.vestingAddress);
    message.enableGovClawback !== undefined &&
      (obj.enableGovClawback = message.enableGovClawback);
    return obj;
  },
...
export const MsgFundVestingAccount = {
  ...
  fromJSON(object: any): MsgFundVestingAccount {
    ...
    if (isSet(object.startTime))
      obj.startTime = fromJsonTimestamp(object.startTime);
    if (Array.isArray(object?.lockupPeriods))
      obj.lockupPeriods = object.lockupPeriods.map((e: any) =>
        Period.fromJSON(e),
      );
    if (Array.isArray(object?.vestingPeriods))
      obj.vestingPeriods = object.vestingPeriods.map((e: any) =>
        Period.fromJSON(e),
      );
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgFundVestingAccount>, I>>(
    object: I,
  ): MsgFundVestingAccount {
    const message = createBaseMsgFundVestingAccount();
    message.funderAddress = object.funderAddress ?? "";
...
export const MsgFundVestingAccountResponse = {
  ...
  encode(
    _: MsgFundVestingAccountResponse,
    writer: BinaryWriter = BinaryWriter.create(),
  ): BinaryWriter {
    return writer;
  },
  ...
  toJSON(
    _: MsgFundVestingAccountResponse,
  ): JsonSafe<MsgFundVestingAccountResponse> {
    const obj: any = {};
    return obj;
  },
...
export const MsgUpdateVestingFunder = {
  ...
  fromJSON(object: any): MsgUpdateVestingFunder {
    ...
    if (isSet(object.funderAddress))
      obj.funderAddress = String(object.funderAddress);
    if (isSet(object.newFunderAddress))
  ...
  toJSON(message: MsgUpdateVestingFunder): JsonSafe<MsgUpdateVestingFunder> {
    ...
    message.funderAddress !== undefined &&
      (obj.funderAddress = message.funderAddress);
    message.newFunderAddress !== undefined &&
      (obj.newFunderAddress = message.newFunderAddress);
    message.vestingAddress !== undefined &&
      (obj.vestingAddress = message.vestingAddress);
    return obj;
  },
  fromPartial<I extends Exact<DeepPartial<MsgUpdateVestingFunder>, I>>(
    object: I,
  ): MsgUpdateVestingFunder {
    const message = createBaseMsgUpdateVestingFunder();
    message.funderAddress = object.funderAddress ?? "";
...
export const MsgUpdateVestingFunderResponse = {
  ...
  encode(
    _: MsgUpdateVestingFunderResponse,
    writer: BinaryWriter = BinaryWriter.create(),
  ): BinaryWriter {
    return writer;
  },
  ...
  toJSON(
    _: MsgUpdateVestingFunderResponse,
  ): JsonSafe<MsgUpdateVestingFunderResponse> {
    const obj: any = {};
    return obj;
  },
...
export const MsgConvertVestingAccount = {
  ...
  toJSON(
    message: MsgConvertVestingAccount,
  ): JsonSafe<MsgConvertVestingAccount> {
    const obj: any = {};
    message.vestingAddress !== undefined &&
      (obj.vestingAddress = message.vestingAddress);
    return obj;
...
export const MsgConvertVestingAccountResponse = {
  ...
  encode(
    _: MsgConvertVestingAccountResponse,
    writer: BinaryWriter = BinaryWriter.create(),
  ): BinaryWriter {
    return writer;
  },
  ...
  toJSON(
    _: MsgConvertVestingAccountResponse,
  ): JsonSafe<MsgConvertVestingAccountResponse> {
    const obj: any = {};
    return obj;
  },
  fromPartial<
    I extends Exact<DeepPartial<MsgConvertVestingAccountResponse>, I>,
  >(_: I): MsgConvertVestingAccountResponse {
    const message = createBaseMsgConvertVestingAccountResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  ): Promise<MsgFundVestingAccountResponse>;
  ...
  ): Promise<MsgUpdateVestingFunderResponse>;
  ...
  ): Promise<MsgConvertVestingAccountResponse>;
}
export class MsgClientImpl implements Msg {
  ...
  FundVestingAccount(
    ...
    return promise.then((data) =>
      MsgFundVestingAccountResponse.decode(new BinaryReader(data)),
    );
  }
  Clawback(request: MsgClawback): Promise<MsgClawbackResponse> {
  ...
  UpdateVestingFunder(
    ...
    return promise.then((data) =>
      MsgUpdateVestingFunderResponse.decode(new BinaryReader(data)),
    );
  }
  ConvertVestingAccount(
    request: MsgConvertVestingAccount,
    ...
    return promise.then((data) =>
      MsgConvertVestingAccountResponse.decode(new BinaryReader(data)),
    );
  }
}
