...
export const QueryCosmosAccountRequest = {
  ...
  toJSON(
    message: QueryCosmosAccountRequest,
  ): JsonSafe<QueryCosmosAccountRequest> {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
    return obj;
  },
...
export const QueryValidatorAccountRequest = {
  ...
  toJSON(
    message: QueryValidatorAccountRequest,
  ): JsonSafe<QueryValidatorAccountRequest> {
    const obj: any = {};
...
export const QueryValidatorAccountResponse = {
  ...
  toJSON(
    message: QueryValidatorAccountResponse,
  ): JsonSafe<QueryValidatorAccountResponse> {
    const obj: any = {};
...
export const EthCallRequest = {
  ...
  toJSON(message: EthCallRequest): JsonSafe<EthCallRequest> {
    ...
    message.gasCap !== undefined &&
      (obj.gasCap = (message.gasCap || BigInt(0)).toString());
    ...
    message.chainId !== undefined &&
      (obj.chainId = (message.chainId || BigInt(0)).toString());
    return obj;
  },
...
export const EstimateGasResponse = {
  ...
  toJSON(message: EstimateGasResponse): JsonSafe<EstimateGasResponse> {
    ...
    message.gas !== undefined &&
      (obj.gas = (message.gas || BigInt(0)).toString());
    return obj;
  },
...
export const QueryTraceTxRequest = {
  ...
  fromJSON(object: any): QueryTraceTxRequest {
    ...
    if (isSet(object.traceConfig))
      obj.traceConfig = TraceConfig.fromJSON(object.traceConfig);
    if (Array.isArray(object?.predecessors))
      obj.predecessors = object.predecessors.map((e: any) =>
    ...
    if (isSet(object.blockTime))
      obj.blockTime = fromJsonTimestamp(object.blockTime);
    if (isSet(object.proposerAddress))
      obj.proposerAddress = bytesFromBase64(object.proposerAddress);
    if (isSet(object.chainId)) obj.chainId = BigInt(object.chainId.toString());
    if (isSet(object.blockMaxGas))
  ...
  toJSON(message: QueryTraceTxRequest): JsonSafe<QueryTraceTxRequest> {
    ...
    message.blockTime !== undefined &&
      (obj.blockTime = fromTimestamp(message.blockTime).toISOString());
    message.proposerAddress !== undefined &&
      (obj.proposerAddress = base64FromBytes(
        message.proposerAddress !== undefined
          ? message.proposerAddress
...
export const QueryTraceBlockRequest = {
  ...
  fromJSON(object: any): QueryTraceBlockRequest {
    ...
    if (Array.isArray(object?.txs))
      obj.txs = object.txs.map((e: any) => MsgEthereumTx.fromJSON(e));
    if (isSet(object.traceConfig))
      obj.traceConfig = TraceConfig.fromJSON(object.traceConfig);
    if (isSet(object.blockNumber))
      obj.blockNumber = BigInt(object.blockNumber.toString());
...
export class QueryClientImpl implements Query {
  ...
  CosmosAccount(
    ...
    return promise.then((data) =>
      QueryCosmosAccountResponse.decode(new BinaryReader(data)),
    );
  }
  ValidatorAccount(
    request: QueryValidatorAccountRequest,
    ...
    return promise.then((data) =>
      QueryValidatorAccountResponse.decode(new BinaryReader(data)),
    );
  }
  Balance(request: QueryBalanceRequest): Promise<QueryBalanceResponse> {
  ...
  Storage(request: QueryStorageRequest): Promise<QueryStorageResponse> {
    ...
    return promise.then((data) =>
      QueryStorageResponse.decode(new BinaryReader(data)),
    );
  }
  Code(request: QueryCodeRequest): Promise<QueryCodeResponse> {
  ...
  EstimateGas(request: EthCallRequest): Promise<EstimateGasResponse> {
    ...
    return promise.then((data) =>
      EstimateGasResponse.decode(new BinaryReader(data)),
    );
  }
  TraceTx(request: QueryTraceTxRequest): Promise<QueryTraceTxResponse> {
    ...
    return promise.then((data) =>
      QueryTraceTxResponse.decode(new BinaryReader(data)),
    );
  }
  TraceBlock(
    ...
    return promise.then((data) =>
      QueryTraceBlockResponse.decode(new BinaryReader(data)),
    );
  }
  BaseFee(request: QueryBaseFeeRequest = {}): Promise<QueryBaseFeeResponse> {
