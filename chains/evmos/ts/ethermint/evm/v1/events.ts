...
export const EventEthereumTx = {
  ...
  fromPartial<I extends Exact<DeepPartial<EventEthereumTx>, I>>(
    object: I,
  ): EventEthereumTx {
    const message = createBaseEventEthereumTx();
...
export const EventTxLog = {
  ...
  fromJSON(object: any): EventTxLog {
    ...
    if (Array.isArray(object?.txLogs))
      obj.txLogs = object.txLogs.map((e: any) => String(e));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EventTxLog>, I>>(
    object: I,
  ): EventTxLog {
    const message = createBaseEventTxLog();
...
export const EventMessage = {
  ...
  fromPartial<I extends Exact<DeepPartial<EventMessage>, I>>(
    object: I,
  ): EventMessage {
    const message = createBaseEventMessage();
...
export const EventBlockBloom = {
  ...
  fromPartial<I extends Exact<DeepPartial<EventBlockBloom>, I>>(
    object: I,
  ): EventBlockBloom {
    const message = createBaseEventBlockBloom();
