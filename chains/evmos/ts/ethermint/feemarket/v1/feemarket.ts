...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.elasticityMultiplier))
      obj.elasticityMultiplier = Number(object.elasticityMultiplier);
    if (isSet(object.enableHeight))
    ...
    if (isSet(object.minGasMultiplier))
  ...
  toJSON(message: Params): JsonSafe<Params> {
    ...
    message.enableHeight !== undefined &&
      (obj.enableHeight = (message.enableHeight || BigInt(0)).toString());
