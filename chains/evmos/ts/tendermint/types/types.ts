...
export const BlockID = {
  ...
  fromJSON(object: any): BlockID {
    ...
    if (isSet(object.hash)) obj.hash = bytesFromBase64(object.hash);
    if (isSet(object.partSetHeader))
      obj.partSetHeader = PartSetHeader.fromJSON(object.partSetHeader);
    return obj;
  },
...
export const Header = {
  ...
  fromJSON(object: any): Header {
    ...
    if (isSet(object.lastBlockId))
      obj.lastBlockId = BlockID.fromJSON(object.lastBlockId);
    if (isSet(object.lastCommitHash))
      obj.lastCommitHash = bytesFromBase64(object.lastCommitHash);
    if (isSet(object.dataHash)) obj.dataHash = bytesFromBase64(object.dataHash);
    if (isSet(object.validatorsHash))
      obj.validatorsHash = bytesFromBase64(object.validatorsHash);
    if (isSet(object.nextValidatorsHash))
      obj.nextValidatorsHash = bytesFromBase64(object.nextValidatorsHash);
    if (isSet(object.consensusHash))
      obj.consensusHash = bytesFromBase64(object.consensusHash);
    if (isSet(object.appHash)) obj.appHash = bytesFromBase64(object.appHash);
    if (isSet(object.lastResultsHash))
      obj.lastResultsHash = bytesFromBase64(object.lastResultsHash);
    if (isSet(object.evidenceHash))
      obj.evidenceHash = bytesFromBase64(object.evidenceHash);
...
export const Vote = {
  ...
  fromJSON(object: any): Vote {
    ...
    if (isSet(object.validatorIndex))
    ...
    if (isSet(object.extension))
      obj.extension = bytesFromBase64(object.extension);
...
export const ExtendedCommit = {
  ...
  fromJSON(object: any): ExtendedCommit {
    ...
    if (Array.isArray(object?.extendedSignatures))
      obj.extendedSignatures = object.extendedSignatures.map((e: any) =>
...
export const LightBlock = {
  ...
  fromJSON(object: any): LightBlock {
    ...
    if (isSet(object.signedHeader))
      obj.signedHeader = SignedHeader.fromJSON(object.signedHeader);
    if (isSet(object.validatorSet))
      obj.validatorSet = ValidatorSet.fromJSON(object.validatorSet);
    return obj;
  },
