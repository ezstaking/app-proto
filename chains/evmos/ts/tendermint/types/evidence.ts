...
export const Evidence = {
  ...
  fromJSON(object: any): Evidence {
    ...
    if (isSet(object.lightClientAttackEvidence))
      obj.lightClientAttackEvidence = LightClientAttackEvidence.fromJSON(
...
export const DuplicateVoteEvidence = {
  ...
  fromJSON(object: any): DuplicateVoteEvidence {
    ...
    if (isSet(object.validatorPower))
...
export const LightClientAttackEvidence = {
  ...
  fromJSON(object: any): LightClientAttackEvidence {
    ...
    if (isSet(object.conflictingBlock))
      obj.conflictingBlock = LightBlock.fromJSON(object.conflictingBlock);
    if (isSet(object.commonHeight))
