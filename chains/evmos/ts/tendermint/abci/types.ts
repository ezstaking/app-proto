...
export const Request = {
  ...
  fromJSON(object: any): Request {
    ...
    if (isSet(object.extendVote))
      obj.extendVote = RequestExtendVote.fromJSON(object.extendVote);
    if (isSet(object.verifyVoteExtension))
      obj.verifyVoteExtension = RequestVerifyVoteExtension.fromJSON(
        object.verifyVoteExtension,
      );
    if (isSet(object.finalizeBlock))
      obj.finalizeBlock = RequestFinalizeBlock.fromJSON(object.finalizeBlock);
    return obj;
  },
...
export const RequestVerifyVoteExtension = {
  ...
  fromJSON(object: any): RequestVerifyVoteExtension {
    ...
    if (isSet(object.validatorAddress))
      obj.validatorAddress = bytesFromBase64(object.validatorAddress);
    if (isSet(object.height)) obj.height = BigInt(object.height.toString());
...
export const Response = {
  ...
  fromJSON(object: any): Response {
    ...
    if (isSet(object.extendVote))
      obj.extendVote = ResponseExtendVote.fromJSON(object.extendVote);
    if (isSet(object.verifyVoteExtension))
      obj.verifyVoteExtension = ResponseVerifyVoteExtension.fromJSON(
        object.verifyVoteExtension,
      );
    if (isSet(object.finalizeBlock))
      obj.finalizeBlock = ResponseFinalizeBlock.fromJSON(object.finalizeBlock);
    return obj;
  },
...
export const ResponseVerifyVoteExtension = {
  ...
  fromJSON(object: any): ResponseVerifyVoteExtension {
    ...
    if (isSet(object.status))
      obj.status = responseVerifyVoteExtension_VerifyStatusFromJSON(
        object.status,
      );
    return obj;
  },
...
export const ResponseFinalizeBlock = {
  ...
  fromJSON(object: any): ResponseFinalizeBlock {
    ...
    if (Array.isArray(object?.txResults))
      obj.txResults = object.txResults.map((e: any) =>
...
export const ExtendedVoteInfo = {
  ...
  fromJSON(object: any): ExtendedVoteInfo {
    ...
    if (isSet(object.voteExtension))
      obj.voteExtension = bytesFromBase64(object.voteExtension);
    if (isSet(object.extensionSignature))
      obj.extensionSignature = bytesFromBase64(object.extensionSignature);
    if (isSet(object.blockIdFlag))
      obj.blockIdFlag = blockIDFlagFromJSON(object.blockIdFlag);
    return obj;
  },
