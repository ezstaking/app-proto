...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.clientConnectionPaths))
      obj.clientConnectionPaths = object.clientConnectionPaths.map((e: any) =>
        ConnectionPaths.fromJSON(e),
      );
    if (isSet(object.nextConnectionSequence))
      obj.nextConnectionSequence = BigInt(
        object.nextConnectionSequence.toString(),
      );
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      ...
      message.nextConnectionSequence = BigInt(
        object.nextConnectionSequence.toString(),
      );
    }
