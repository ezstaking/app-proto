...
export const MsgUpdateClient = {
  ...
  fromJSON(object: any): MsgUpdateClient {
    ...
    if (isSet(object.clientMessage))
      obj.clientMessage = Any.fromJSON(object.clientMessage);
    if (isSet(object.signer)) obj.signer = String(object.signer);
    return obj;
  },
...
export const MsgUpgradeClient = {
  ...
  fromJSON(object: any): MsgUpgradeClient {
    ...
    if (isSet(object.consensusState))
      obj.consensusState = Any.fromJSON(object.consensusState);
    if (isSet(object.proofUpgradeClient))
      obj.proofUpgradeClient = bytesFromBase64(object.proofUpgradeClient);
    if (isSet(object.proofUpgradeConsensusState))
      obj.proofUpgradeConsensusState = bytesFromBase64(
...
export const MsgSubmitMisbehaviour = {
  ...
  fromJSON(object: any): MsgSubmitMisbehaviour {
    ...
    if (isSet(object.clientId)) obj.clientId = String(object.clientId);
    if (isSet(object.misbehaviour))
      obj.misbehaviour = Any.fromJSON(object.misbehaviour);
    if (isSet(object.signer)) obj.signer = String(object.signer);
    return obj;
  },
...
export const MsgRecoverClient = {
  ...
  fromJSON(object: any): MsgRecoverClient {
    ...
    if (isSet(object.subjectClientId))
      obj.subjectClientId = String(object.subjectClientId);
    if (isSet(object.substituteClientId))
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRecoverClient>, I>>(
    object: I,
  ): MsgRecoverClient {
    const message = createBaseMsgRecoverClient();
...
export const MsgIBCSoftwareUpgrade = {
  ...
  fromJSON(object: any): MsgIBCSoftwareUpgrade {
    ...
    if (isSet(object.upgradedClientState))
      obj.upgradedClientState = Any.fromJSON(object.upgradedClientState);
    if (isSet(object.signer)) obj.signer = String(object.signer);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgIBCSoftwareUpgrade>, I>>(
    object: I,
  ): MsgIBCSoftwareUpgrade {
    const message = createBaseMsgIBCSoftwareUpgrade();
