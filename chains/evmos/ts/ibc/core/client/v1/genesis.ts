...
export const IdentifiedGenesisMetadata = {
  ...
  fromJSON(object: any): IdentifiedGenesisMetadata {
    ...
    if (Array.isArray(object?.clientMetadata))
      obj.clientMetadata = object.clientMetadata.map((e: any) =>
