...
export const QueryChecksumsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryChecksumsRequest>, I>>(
    object: I,
  ): QueryChecksumsRequest {
    const message = createBaseQueryChecksumsRequest();
...
export const QueryChecksumsResponse = {
  ...
  fromJSON(object: any): QueryChecksumsResponse {
    ...
    if (Array.isArray(object?.checksums))
      obj.checksums = object.checksums.map((e: any) => String(e));
    if (isSet(object.pagination))
  ...
  fromPartial<I extends Exact<DeepPartial<QueryChecksumsResponse>, I>>(
    object: I,
  ): QueryChecksumsResponse {
    const message = createBaseQueryChecksumsResponse();
