...
export const IncentivizedAcknowledgement = {
  ...
  fromJSON(object: any): IncentivizedAcknowledgement {
    ...
    if (isSet(object.appAcknowledgement))
      obj.appAcknowledgement = bytesFromBase64(object.appAcknowledgement);
    if (isSet(object.forwardRelayerAddress))
      obj.forwardRelayerAddress = String(object.forwardRelayerAddress);
    if (isSet(object.underlyingAppSuccess))
      obj.underlyingAppSuccess = Boolean(object.underlyingAppSuccess);
    return obj;
  },
  toJSON(
    message: IncentivizedAcknowledgement,
  ): JsonSafe<IncentivizedAcknowledgement> {
    const obj: any = {};
