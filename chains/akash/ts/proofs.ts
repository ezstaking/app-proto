...
export const ExistenceProof = {
  ...
  fromJSON(object: any): ExistenceProof {
    ...
    if (Array.isArray(object?.path))
      obj.path = object.path.map((e: any) => InnerOp.fromJSON(e));
    return obj;
  },
...
export const CommitmentProof = {
  ...
  fromJSON(object: any): CommitmentProof {
    ...
    if (isSet(object.nonexist))
      obj.nonexist = NonExistenceProof.fromJSON(object.nonexist);
    if (isSet(object.batch)) obj.batch = BatchProof.fromJSON(object.batch);
    if (isSet(object.compressed))
      obj.compressed = CompressedBatchProof.fromJSON(object.compressed);
    return obj;
  },
...
export const LeafOp = {
  ...
  fromJSON(object: any): LeafOp {
    ...
    if (isSet(object.prehashKey))
      obj.prehashKey = hashOpFromJSON(object.prehashKey);
    if (isSet(object.prehashValue))
...
export const ProofSpec = {
  ...
  fromJSON(object: any): ProofSpec {
    ...
    if (isSet(object.innerSpec))
      obj.innerSpec = InnerSpec.fromJSON(object.innerSpec);
    ...
    if (isSet(object.prehashKeyBeforeComparison))
      obj.prehashKeyBeforeComparison = Boolean(
...
export const InnerSpec = {
  ...
  fromJSON(object: any): InnerSpec {
    ...
    if (Array.isArray(object?.childOrder))
      obj.childOrder = object.childOrder.map((e: any) => Number(e));
    if (isSet(object.childSize)) obj.childSize = Number(object.childSize);
    if (isSet(object.minPrefixLength))
      obj.minPrefixLength = Number(object.minPrefixLength);
    if (isSet(object.maxPrefixLength))
      obj.maxPrefixLength = Number(object.maxPrefixLength);
    if (isSet(object.emptyChild))
      obj.emptyChild = bytesFromBase64(object.emptyChild);
    if (isSet(object.hash)) obj.hash = hashOpFromJSON(object.hash);
    return obj;
  },
...
export const BatchProof = {
  ...
  fromJSON(object: any): BatchProof {
    ...
    if (Array.isArray(object?.entries))
      obj.entries = object.entries.map((e: any) => BatchEntry.fromJSON(e));
    return obj;
  },
...
export const CompressedBatchProof = {
  ...
  fromJSON(object: any): CompressedBatchProof {
    ...
    if (Array.isArray(object?.lookupInners))
      obj.lookupInners = object.lookupInners.map((e: any) =>
        InnerOp.fromJSON(e),
      );
    return obj;
  },
...
export const CompressedBatchEntry = {
  ...
  fromJSON(object: any): CompressedBatchEntry {
    ...
    if (isSet(object.exist))
      obj.exist = CompressedExistenceProof.fromJSON(object.exist);
    if (isSet(object.nonexist))
      obj.nonexist = CompressedNonExistenceProof.fromJSON(object.nonexist);
    return obj;
  },
...
export const CompressedNonExistenceProof = {
  ...
  fromJSON(object: any): CompressedNonExistenceProof {
    ...
    if (isSet(object.left))
      obj.left = CompressedExistenceProof.fromJSON(object.left);
    if (isSet(object.right))
      obj.right = CompressedExistenceProof.fromJSON(object.right);
    return obj;
  },
  toJSON(
    message: CompressedNonExistenceProof,
