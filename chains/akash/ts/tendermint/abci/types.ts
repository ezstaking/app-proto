...
export const Request = {
  ...
  fromJSON(object: any): Request {
    ...
    if (isSet(object.setOption))
      obj.setOption = RequestSetOption.fromJSON(object.setOption);
...
export const RequestBeginBlock = {
  ...
  fromJSON(object: any): RequestBeginBlock {
    ...
    if (isSet(object.lastCommitInfo))
      obj.lastCommitInfo = LastCommitInfo.fromJSON(object.lastCommitInfo);
...
export const Response = {
  ...
  fromJSON(object: any): Response {
    ...
    if (isSet(object.setOption))
      obj.setOption = ResponseSetOption.fromJSON(object.setOption);
    if (isSet(object.initChain))
...
export const ConsensusParams = {
  ...
  fromJSON(object: any): ConsensusParams {
    ...
    if (isSet(object.evidence))
      obj.evidence = EvidenceParams.fromJSON(object.evidence);
    if (isSet(object.validator))
      obj.validator = ValidatorParams.fromJSON(object.validator);
    if (isSet(object.version))
      obj.version = VersionParams.fromJSON(object.version);
    return obj;
  },
...
export class ABCIApplicationClientImpl implements ABCIApplication {
  ...
  SetOption(request: RequestSetOption): Promise<ResponseSetOption> {
    ...
    return promise.then((data) =>
      ResponseSetOption.decode(new BinaryReader(data)),
    );
  }
  DeliverTx(request: RequestDeliverTx): Promise<ResponseDeliverTx> {
