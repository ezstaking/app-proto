...
export const BlockMetadata = {
  ...
  fromJSON(object: any): BlockMetadata {
    ...
    if (isSet(object.requestBeginBlock))
      obj.requestBeginBlock = RequestBeginBlock.fromJSON(
        object.requestBeginBlock,
      );
    if (isSet(object.responseBeginBlock))
      obj.responseBeginBlock = ResponseBeginBlock.fromJSON(
        object.responseBeginBlock,
      );
    if (Array.isArray(object?.deliverTxs))
      obj.deliverTxs = object.deliverTxs.map((e: any) =>
        BlockMetadata_DeliverTx.fromJSON(e),
      );
    if (isSet(object.requestEndBlock))
      obj.requestEndBlock = RequestEndBlock.fromJSON(object.requestEndBlock);
    if (isSet(object.responseEndBlock))
      obj.responseEndBlock = ResponseEndBlock.fromJSON(object.responseEndBlock);
    if (isSet(object.responseCommit))
      obj.responseCommit = ResponseCommit.fromJSON(object.responseCommit);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<BlockMetadata>, I>>(
    ...
    if (
      ...
      message.requestBeginBlock = RequestBeginBlock.fromPartial(
        object.requestBeginBlock,
      );
    }
    if (
      ...
      message.responseBeginBlock = ResponseBeginBlock.fromPartial(
        object.responseBeginBlock,
      );
    }
    message.deliverTxs =
      ...
      [];
    if (
      object.requestEndBlock !== undefined &&
      object.requestEndBlock !== null
    ) {
      message.requestEndBlock = RequestEndBlock.fromPartial(
        object.requestEndBlock,
      );
    }
    if (
      object.responseEndBlock !== undefined &&
      object.responseEndBlock !== null
    ) {
      message.responseEndBlock = ResponseEndBlock.fromPartial(
        object.responseEndBlock,
      );
    }
...
export const BlockMetadata_DeliverTx = {
  ...
  fromJSON(object: any): BlockMetadata_DeliverTx {
    ...
    if (isSet(object.request))
      obj.request = RequestDeliverTx.fromJSON(object.request);
    if (isSet(object.response))
      obj.response = ResponseDeliverTx.fromJSON(object.response);
    return obj;
  },
  toJSON(message: BlockMetadata_DeliverTx): JsonSafe<BlockMetadata_DeliverTx> {
    const obj: any = {};
