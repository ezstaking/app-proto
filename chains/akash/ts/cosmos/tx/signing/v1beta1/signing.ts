...
export const SignatureDescriptors = {
  ...
  fromJSON(object: any): SignatureDescriptors {
    ...
    if (Array.isArray(object?.signatures))
      obj.signatures = object.signatures.map((e: any) =>
...
export const SignatureDescriptor = {
  ...
  fromJSON(object: any): SignatureDescriptor {
    ...
    if (isSet(object.data))
      obj.data = SignatureDescriptor_Data.fromJSON(object.data);
...
export const SignatureDescriptor_Data = {
  ...
  fromJSON(object: any): SignatureDescriptor_Data {
    ...
    if (isSet(object.single))
      obj.single = SignatureDescriptor_Data_Single.fromJSON(object.single);
    if (isSet(object.multi))
