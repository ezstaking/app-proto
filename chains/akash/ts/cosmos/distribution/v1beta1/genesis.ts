...
export const ValidatorAccumulatedCommissionRecord = {
  ...
  fromJSON(object: any): ValidatorAccumulatedCommissionRecord {
    ...
    if (isSet(object.accumulated))
      obj.accumulated = ValidatorAccumulatedCommission.fromJSON(
        object.accumulated,
      );
    return obj;
  },
...
export const ValidatorHistoricalRewardsRecord = {
  ...
  fromJSON(object: any): ValidatorHistoricalRewardsRecord {
    ...
    if (isSet(object.rewards))
      obj.rewards = ValidatorHistoricalRewards.fromJSON(object.rewards);
    return obj;
  },
  toJSON(
    message: ValidatorHistoricalRewardsRecord,
...
export const ValidatorCurrentRewardsRecord = {
  ...
  fromJSON(object: any): ValidatorCurrentRewardsRecord {
    ...
    if (isSet(object.validatorAddress))
      obj.validatorAddress = String(object.validatorAddress);
    if (isSet(object.rewards))
      obj.rewards = ValidatorCurrentRewards.fromJSON(object.rewards);
    return obj;
  },
  toJSON(
    message: ValidatorCurrentRewardsRecord,
...
export const DelegatorStartingInfoRecord = {
  ...
  fromJSON(object: any): DelegatorStartingInfoRecord {
    ...
    if (isSet(object.validatorAddress))
      obj.validatorAddress = String(object.validatorAddress);
    if (isSet(object.startingInfo))
      obj.startingInfo = DelegatorStartingInfo.fromJSON(object.startingInfo);
    return obj;
  },
  toJSON(
    message: DelegatorStartingInfoRecord,
...
export const ValidatorSlashEventRecord = {
  ...
  fromJSON(object: any): ValidatorSlashEventRecord {
    ...
    if (isSet(object.validatorSlashEvent))
      obj.validatorSlashEvent = ValidatorSlashEvent.fromJSON(
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.previousProposer))
    ...
    if (Array.isArray(object?.validatorHistoricalRewards))
      obj.validatorHistoricalRewards = object.validatorHistoricalRewards.map(
        (e: any) => ValidatorHistoricalRewardsRecord.fromJSON(e),
      );
    if (Array.isArray(object?.validatorCurrentRewards))
      obj.validatorCurrentRewards = object.validatorCurrentRewards.map(
        (e: any) => ValidatorCurrentRewardsRecord.fromJSON(e),
      );
