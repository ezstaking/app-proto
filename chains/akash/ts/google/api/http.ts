...
export const Http = {
  ...
  fromJSON(object: any): Http {
    ...
    if (Array.isArray(object?.rules))
      obj.rules = object.rules.map((e: any) => HttpRule.fromJSON(e));
    if (isSet(object.fullyDecodeReservedExpansion))
      obj.fullyDecodeReservedExpansion = Boolean(
...
export const HttpRule = {
  ...
  fromJSON(object: any): HttpRule {
    ...
    if (Array.isArray(object?.additionalBindings))
      obj.additionalBindings = object.additionalBindings.map((e: any) =>
        HttpRule.fromJSON(e),
      );
    return obj;
  },
