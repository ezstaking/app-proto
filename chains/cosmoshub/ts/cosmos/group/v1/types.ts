...
export const ThresholdDecisionPolicy = {
  ...
  fromJSON(object: any): ThresholdDecisionPolicy {
    ...
    if (isSet(object.windows))
      obj.windows = DecisionPolicyWindows.fromJSON(object.windows);
    return obj;
  },
...
export const GroupInfo = {
  ...
  fromJSON(object: any): GroupInfo {
    ...
    if (isSet(object.createdAt))
      obj.createdAt = fromJsonTimestamp(object.createdAt);
    return obj;
  },
...
export const GroupPolicyInfo = {
  ...
  fromJSON(object: any): GroupPolicyInfo {
    ...
    if (isSet(object.decisionPolicy))
      obj.decisionPolicy = Any.fromJSON(object.decisionPolicy);
    if (isSet(object.createdAt))
      obj.createdAt = fromJsonTimestamp(object.createdAt);
    return obj;
  },
...
export const Proposal = {
  ...
  fromJSON(object: any): Proposal {
    ...
    if (isSet(object.votingPeriodEnd))
      obj.votingPeriodEnd = fromJsonTimestamp(object.votingPeriodEnd);
    if (isSet(object.executorResult))
      obj.executorResult = proposalExecutorResultFromJSON(
