...
export const ValidatorHistoricalRewards = {
  ...
  fromJSON(object: any): ValidatorHistoricalRewards {
    ...
    if (Array.isArray(object?.cumulativeRewardRatio))
      obj.cumulativeRewardRatio = object.cumulativeRewardRatio.map((e: any) =>
        DecCoin.fromJSON(e),
      );
    if (isSet(object.referenceCount))
...
export const ValidatorSlashEvent = {
  ...
  fromJSON(object: any): ValidatorSlashEvent {
    ...
    if (isSet(object.validatorPeriod))
...
export const FeePool = {
  ...
  fromJSON(object: any): FeePool {
    ...
    if (Array.isArray(object?.communityPool))
      obj.communityPool = object.communityPool.map((e: any) =>
        DecCoin.fromJSON(e),
      );
    return obj;
  },
...
export const TokenizeShareRecordReward = {
  ...
  fromJSON(object: any): TokenizeShareRecordReward {
    ...
    if (isSet(object.recordId))
      obj.recordId = BigInt(object.recordId.toString());
    if (Array.isArray(object?.reward))
      obj.reward = object.reward.map((e: any) => DecCoin.fromJSON(e));
    return obj;
  },
  toJSON(
    message: TokenizeShareRecordReward,
  ): JsonSafe<TokenizeShareRecordReward> {
    const obj: any = {};
...
export const DelegatorStartingInfo = {
  ...
  fromJSON(object: any): DelegatorStartingInfo {
    ...
    if (isSet(object.previousPeriod))
