...
export const QueryValidatorDistributionInfoResponse = {
  ...
  fromJSON(object: any): QueryValidatorDistributionInfoResponse {
    ...
    if (Array.isArray(object?.selfBondRewards))
      obj.selfBondRewards = object.selfBondRewards.map((e: any) =>
        DecCoin.fromJSON(e),
      );
...
export const QueryValidatorOutstandingRewardsResponse = {
  ...
  fromJSON(object: any): QueryValidatorOutstandingRewardsResponse {
    ...
    if (isSet(object.rewards))
      obj.rewards = ValidatorOutstandingRewards.fromJSON(object.rewards);
    return obj;
  },
  toJSON(
    message: QueryValidatorOutstandingRewardsResponse,
...
export const QueryValidatorCommissionResponse = {
  ...
  fromJSON(object: any): QueryValidatorCommissionResponse {
    ...
    if (isSet(object.commission))
      obj.commission = ValidatorAccumulatedCommission.fromJSON(
        object.commission,
      );
    return obj;
  },
...
export const QueryValidatorSlashesRequest = {
  ...
  fromJSON(object: any): QueryValidatorSlashesRequest {
    ...
    if (isSet(object.validatorAddress))
      obj.validatorAddress = String(object.validatorAddress);
    if (isSet(object.startingHeight))
      obj.startingHeight = BigInt(object.startingHeight.toString());
    if (isSet(object.endingHeight))
...
export const QueryValidatorSlashesResponse = {
  ...
  fromJSON(object: any): QueryValidatorSlashesResponse {
    ...
    if (Array.isArray(object?.slashes))
      obj.slashes = object.slashes.map((e: any) =>
...
export const QueryDelegationRewardsResponse = {
  ...
  fromJSON(object: any): QueryDelegationRewardsResponse {
    ...
    if (Array.isArray(object?.rewards))
      obj.rewards = object.rewards.map((e: any) => DecCoin.fromJSON(e));
    return obj;
  },
  toJSON(
    message: QueryDelegationRewardsResponse,
...
export const QueryDelegationTotalRewardsResponse = {
  ...
  fromJSON(object: any): QueryDelegationTotalRewardsResponse {
    ...
    if (Array.isArray(object?.rewards))
      obj.rewards = object.rewards.map((e: any) =>
        DelegationDelegatorReward.fromJSON(e),
      );
    if (Array.isArray(object?.total))
      obj.total = object.total.map((e: any) => DecCoin.fromJSON(e));
    return obj;
  },
  toJSON(
    message: QueryDelegationTotalRewardsResponse,
...
export const QueryCommunityPoolResponse = {
  ...
  fromJSON(object: any): QueryCommunityPoolResponse {
    ...
    if (Array.isArray(object?.pool))
      obj.pool = object.pool.map((e: any) => DecCoin.fromJSON(e));
    return obj;
  },
  toJSON(
    message: QueryCommunityPoolResponse,
...
export const QueryTokenizeShareRecordRewardRequest = {
  ...
  toJSON(
    message: QueryTokenizeShareRecordRewardRequest,
  ): JsonSafe<QueryTokenizeShareRecordRewardRequest> {
    const obj: any = {};
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryTokenizeShareRecordRewardRequest>, I>,
  >(object: I): QueryTokenizeShareRecordRewardRequest {
    const message = createBaseQueryTokenizeShareRecordRewardRequest();
...
export const QueryTokenizeShareRecordRewardResponse = {
  ...
  fromJSON(object: any): QueryTokenizeShareRecordRewardResponse {
    ...
    if (Array.isArray(object?.rewards))
      obj.rewards = object.rewards.map((e: any) =>
        TokenizeShareRecordReward.fromJSON(e),
      );
    if (Array.isArray(object?.total))
      obj.total = object.total.map((e: any) => DecCoin.fromJSON(e));
    return obj;
  ...
  toJSON(
    message: QueryTokenizeShareRecordRewardResponse,
  ): JsonSafe<QueryTokenizeShareRecordRewardResponse> {
    const obj: any = {};
    if (message.rewards) {
      obj.rewards = message.rewards.map((e) =>
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryTokenizeShareRecordRewardResponse>, I>,
  >(object: I): QueryTokenizeShareRecordRewardResponse {
    const message = createBaseQueryTokenizeShareRecordRewardResponse();
    message.rewards =
      object.rewards?.map((e) => TokenizeShareRecordReward.fromPartial(e)) ||
      [];
    message.total = object.total?.map((e) => DecCoin.fromPartial(e)) || [];
    return message;
  },
...
export class QueryClientImpl implements Query {
  ...
  TokenizeShareRecordReward(
    ...
    return promise.then((data) =>
      QueryTokenizeShareRecordRewardResponse.decode(new BinaryReader(data)),
    );
  }
}
