...
export const MsgWithdrawTokenizeShareRecordReward = {
  ...
  toJSON(
    message: MsgWithdrawTokenizeShareRecordReward,
  ): JsonSafe<MsgWithdrawTokenizeShareRecordReward> {
    const obj: any = {};
...
export const MsgWithdrawTokenizeShareRecordRewardResponse = {
  ...
  toJSON(
    _: MsgWithdrawTokenizeShareRecordRewardResponse,
  ): JsonSafe<MsgWithdrawTokenizeShareRecordRewardResponse> {
    const obj: any = {};
    return obj;
  },
  fromPartial<
...
export const MsgWithdrawAllTokenizeShareRecordReward = {
  ...
  toJSON(
    message: MsgWithdrawAllTokenizeShareRecordReward,
  ): JsonSafe<MsgWithdrawAllTokenizeShareRecordReward> {
    const obj: any = {};
    message.ownerAddress !== undefined &&
      (obj.ownerAddress = message.ownerAddress);
    return obj;
...
export const MsgWithdrawAllTokenizeShareRecordRewardResponse = {
  typeUrl:
    "/cosmos.distribution.v1beta1.MsgWithdrawAllTokenizeShareRecordRewardResponse",
  encode(
  ...
  toJSON(
    _: MsgWithdrawAllTokenizeShareRecordRewardResponse,
  ): JsonSafe<MsgWithdrawAllTokenizeShareRecordRewardResponse> {
    const obj: any = {};
    return obj;
  },
  fromPartial<
...
export class MsgClientImpl implements Msg {
  ...
  WithdrawTokenizeShareRecordReward(
    ...
    return promise.then((data) =>
      MsgWithdrawTokenizeShareRecordRewardResponse.decode(
