...
export const Tx = {
  ...
  fromJSON(object: any): Tx {
    ...
    if (isSet(object.authInfo))
      obj.authInfo = AuthInfo.fromJSON(object.authInfo);
...
export const TxRaw = {
  ...
  fromJSON(object: any): TxRaw {
    ...
    if (isSet(object.bodyBytes))
      obj.bodyBytes = bytesFromBase64(object.bodyBytes);
    if (isSet(object.authInfoBytes))
      obj.authInfoBytes = bytesFromBase64(object.authInfoBytes);
    if (Array.isArray(object?.signatures))
      obj.signatures = object.signatures.map((e: any) => bytesFromBase64(e));
    return obj;
  },
...
export const TxBody = {
  ...
  fromJSON(object: any): TxBody {
    ...
    if (Array.isArray(object?.extensionOptions))
      obj.extensionOptions = object.extensionOptions.map((e: any) =>
        Any.fromJSON(e),
      );
    if (Array.isArray(object?.nonCriticalExtensionOptions))
      obj.nonCriticalExtensionOptions = object.nonCriticalExtensionOptions.map(
...
export const AuthInfo = {
  ...
  fromJSON(object: any): AuthInfo {
    ...
    if (Array.isArray(object?.signerInfos))
      obj.signerInfos = object.signerInfos.map((e: any) =>
...
export const SignerInfo = {
  ...
  fromJSON(object: any): SignerInfo {
    ...
    if (isSet(object.publicKey)) obj.publicKey = Any.fromJSON(object.publicKey);
    if (isSet(object.modeInfo))
      obj.modeInfo = ModeInfo.fromJSON(object.modeInfo);
    if (isSet(object.sequence))
      obj.sequence = BigInt(object.sequence.toString());
    return obj;
  },
...
export const ModeInfo = {
  ...
  fromJSON(object: any): ModeInfo {
    ...
    if (isSet(object.single))
      obj.single = ModeInfo_Single.fromJSON(object.single);
...
export const ModeInfo_Multi = {
  ...
  fromJSON(object: any): ModeInfo_Multi {
    ...
    if (isSet(object.bitarray))
      obj.bitarray = CompactBitArray.fromJSON(object.bitarray);
...
export const AuxSignerData = {
  ...
  fromJSON(object: any): AuxSignerData {
    ...
    if (isSet(object.signDoc))
      obj.signDoc = SignDocDirectAux.fromJSON(object.signDoc);
    if (isSet(object.mode)) obj.mode = signModeFromJSON(object.mode);
