...
export const FileDescriptorsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<FileDescriptorsRequest>, I>>(
    _: I,
  ): FileDescriptorsRequest {
    const message = createBaseFileDescriptorsRequest();
    return message;
...
export const FileDescriptorsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<FileDescriptorsResponse>, I>>(
    object: I,
  ): FileDescriptorsResponse {
    const message = createBaseFileDescriptorsResponse();
    message.files =
...
export class ReflectionServiceClientImpl implements ReflectionService {
  ...
  FileDescriptors(
    ...
    return promise.then((data) =>
      FileDescriptorsResponse.decode(new BinaryReader(data)),
    );
  }
}
