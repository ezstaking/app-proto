...
export const ValidatorSigningInfo = {
  ...
  fromJSON(object: any): ValidatorSigningInfo {
    ...
    if (isSet(object.startHeight))
      obj.startHeight = BigInt(object.startHeight.toString());
    if (isSet(object.indexOffset))
      obj.indexOffset = BigInt(object.indexOffset.toString());
    if (isSet(object.jailedUntil))
      obj.jailedUntil = fromJsonTimestamp(object.jailedUntil);
  ...
  toJSON(message: ValidatorSigningInfo): JsonSafe<ValidatorSigningInfo> {
    ...
    message.startHeight !== undefined &&
      (obj.startHeight = (message.startHeight || BigInt(0)).toString());
    message.indexOffset !== undefined &&
      (obj.indexOffset = (message.indexOffset || BigInt(0)).toString());
    ...
    message.missedBlocksCounter !== undefined &&
      (obj.missedBlocksCounter = (
        message.missedBlocksCounter || BigInt(0)
      ).toString());
    return obj;
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorSigningInfo>, I>>(
    ...
    if (
      ...
      message.missedBlocksCounter = BigInt(
        object.missedBlocksCounter.toString(),
      );
    }
    return message;
  },
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.minSignedPerWindow))
      obj.minSignedPerWindow = bytesFromBase64(object.minSignedPerWindow);
    ...
    if (isSet(object.slashFractionDoubleSign))
      obj.slashFractionDoubleSign = bytesFromBase64(
  ...
  toJSON(message: Params): JsonSafe<Params> {
    ...
    message.signedBlocksWindow !== undefined &&
      (obj.signedBlocksWindow = (
        message.signedBlocksWindow || BigInt(0)
      ).toString());
