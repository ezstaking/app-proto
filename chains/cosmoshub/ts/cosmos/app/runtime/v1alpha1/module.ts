...
export const Module = {
  ...
  fromJSON(object: any): Module {
    ...
    if (Array.isArray(object?.endBlockers))
      obj.endBlockers = object.endBlockers.map((e: any) => String(e));
    if (Array.isArray(object?.initGenesis))
      obj.initGenesis = object.initGenesis.map((e: any) => String(e));
    ...
    if (Array.isArray(object?.overrideStoreKeys))
      obj.overrideStoreKeys = object.overrideStoreKeys.map((e: any) =>
    ...
    if (Array.isArray(object?.prepareCheckStaters))
      obj.prepareCheckStaters = object.prepareCheckStaters.map((e: any) =>
        String(e),
      );
    return obj;
  },
...
export const StoreKeyConfig = {
  ...
  fromPartial<I extends Exact<DeepPartial<StoreKeyConfig>, I>>(
    object: I,
  ): StoreKeyConfig {
    const message = createBaseStoreKeyConfig();
