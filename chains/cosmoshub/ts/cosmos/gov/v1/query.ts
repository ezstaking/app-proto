...
export const QueryProposalResponse = {
  ...
  fromJSON(object: any): QueryProposalResponse {
    ...
    if (isSet(object.proposal))
      obj.proposal = Proposal.fromJSON(object.proposal);
    return obj;
  },
...
export const QueryProposalsRequest = {
  ...
  fromJSON(object: any): QueryProposalsRequest {
    ...
    if (isSet(object.proposalStatus))
      obj.proposalStatus = proposalStatusFromJSON(object.proposalStatus);
...
export const QueryParamsResponse = {
  ...
  fromJSON(object: any): QueryParamsResponse {
    ...
    if (isSet(object.votingParams))
      obj.votingParams = VotingParams.fromJSON(object.votingParams);
    if (isSet(object.depositParams))
...
export const QueryDepositsResponse = {
  ...
  fromJSON(object: any): QueryDepositsResponse {
    ...
    if (Array.isArray(object?.deposits))
      obj.deposits = object.deposits.map((e: any) => Deposit.fromJSON(e));
    if (isSet(object.pagination))
      obj.pagination = PageResponse.fromJSON(object.pagination);
    return obj;
  },
