...
export const TxResponse = {
  ...
  fromJSON(object: any): TxResponse {
    ...
    if (Array.isArray(object?.logs))
      obj.logs = object.logs.map((e: any) => ABCIMessageLog.fromJSON(e));
    if (isSet(object.info)) obj.info = String(object.info);
    if (isSet(object.gasWanted))
...
export const ABCIMessageLog = {
  ...
  fromJSON(object: any): ABCIMessageLog {
    ...
    if (Array.isArray(object?.events))
      obj.events = object.events.map((e: any) => StringEvent.fromJSON(e));
    return obj;
  },
...
export const TxMsgData = {
  ...
  fromJSON(object: any): TxMsgData {
    ...
    if (Array.isArray(object?.data))
      obj.data = object.data.map((e: any) => MsgData.fromJSON(e));
    if (Array.isArray(object?.msgResponses))
      obj.msgResponses = object.msgResponses.map((e: any) => Any.fromJSON(e));
    return obj;
  },
...
export const SearchTxsResult = {
  ...
  fromJSON(object: any): SearchTxsResult {
    ...
    if (Array.isArray(object?.txs))
      obj.txs = object.txs.map((e: any) => TxResponse.fromJSON(e));
    return obj;
  },
...
export const SearchBlocksResult = {
  ...
  fromJSON(object: any): SearchBlocksResult {
    ...
    if (Array.isArray(object?.blocks))
      obj.blocks = object.blocks.map((e: any) => Block.fromJSON(e));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SearchBlocksResult>, I>>(
    object: I,
  ): SearchBlocksResult {
    const message = createBaseSearchBlocksResult();
    if (object.totalCount !== undefined && object.totalCount !== null) {
