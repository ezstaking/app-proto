...
export const StatusResponse = {
  ...
  fromJSON(object: any): StatusResponse {
    ...
    if (isSet(object.validatorHash))
      obj.validatorHash = bytesFromBase64(object.validatorHash);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<StatusResponse>, I>>(
    ...
    if (
      ...
      message.earliestStoreHeight = BigInt(
        object.earliestStoreHeight.toString(),
      );
    }
...
export class ServiceClientImpl implements Service {
  ...
  Config(request: ConfigRequest = {}): Promise<ConfigResponse> {
    ...
    return promise.then((data) =>
      ConfigResponse.decode(new BinaryReader(data)),
    );
  }
  Status(request: StatusRequest = {}): Promise<StatusResponse> {
    ...
    return promise.then((data) =>
      StatusResponse.decode(new BinaryReader(data)),
    );
  }
}
