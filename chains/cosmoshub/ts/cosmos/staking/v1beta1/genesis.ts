...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.lastTotalPower))
      obj.lastTotalPower = bytesFromBase64(object.lastTotalPower);
    if (Array.isArray(object?.lastValidatorPowers))
      obj.lastValidatorPowers = object.lastValidatorPowers.map((e: any) =>
    ...
    if (Array.isArray(object?.delegations))
      obj.delegations = object.delegations.map((e: any) =>
        Delegation.fromJSON(e),
      );
    if (Array.isArray(object?.unbondingDelegations))
      obj.unbondingDelegations = object.unbondingDelegations.map((e: any) =>
        UnbondingDelegation.fromJSON(e),
      );
    if (Array.isArray(object?.redelegations))
      obj.redelegations = object.redelegations.map((e: any) =>
    ...
    if (Array.isArray(object?.tokenizeShareRecords))
      obj.tokenizeShareRecords = object.tokenizeShareRecords.map((e: any) =>
        TokenizeShareRecord.fromJSON(e),
      );
    if (isSet(object.lastTokenizeShareRecordId))
      obj.lastTokenizeShareRecordId = BigInt(
        object.lastTokenizeShareRecordId.toString(),
      );
    if (isSet(object.totalLiquidStakedTokens))
      obj.totalLiquidStakedTokens = bytesFromBase64(
        object.totalLiquidStakedTokens,
      );
    if (Array.isArray(object?.tokenizeShareLocks))
      obj.tokenizeShareLocks = object.tokenizeShareLocks.map((e: any) =>
  ...
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    message.lastTokenizeShareRecordId !== undefined &&
      (obj.lastTokenizeShareRecordId = (
        message.lastTokenizeShareRecordId || BigInt(0)
      ).toString());
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      ...
      message.lastTokenizeShareRecordId = BigInt(
        object.lastTokenizeShareRecordId.toString(),
      );
    }
    message.totalLiquidStakedTokens =
...
export const TokenizeShareLock = {
  ...
  toJSON(message: TokenizeShareLock): JsonSafe<TokenizeShareLock> {
    const obj: any = {};
