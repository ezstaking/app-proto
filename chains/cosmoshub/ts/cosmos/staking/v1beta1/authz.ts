...
export const StakeAuthorization = {
  ...
  fromJSON(object: any): StakeAuthorization {
    ...
    if (isSet(object.maxTokens))
      obj.maxTokens = Coin.fromJSON(object.maxTokens);
    if (isSet(object.allowList))
      obj.allowList = StakeAuthorization_Validators.fromJSON(object.allowList);
    if (isSet(object.denyList))
      obj.denyList = StakeAuthorization_Validators.fromJSON(object.denyList);
    if (isSet(object.authorizationType))
      obj.authorizationType = authorizationTypeFromJSON(
...
export const StakeAuthorization_Validators = {
  ...
  fromJSON(object: any): StakeAuthorization_Validators {
    ...
    if (Array.isArray(object?.address))
      obj.address = object.address.map((e: any) => String(e));
    return obj;
  },
  toJSON(
    message: StakeAuthorization_Validators,
