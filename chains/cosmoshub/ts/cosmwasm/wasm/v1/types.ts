...
export const ContractInfo = {
  ...
  fromJSON(object: any): ContractInfo {
    ...
    if (isSet(object.created))
      obj.created = AbsoluteTxPosition.fromJSON(object.created);
...
export const ContractCodeHistoryEntry = {
  ...
  fromJSON(object: any): ContractCodeHistoryEntry {
    ...
    if (isSet(object.operation))
      obj.operation = contractCodeHistoryOperationTypeFromJSON(
        object.operation,
      );
    if (isSet(object.codeId)) obj.codeId = BigInt(object.codeId.toString());
    if (isSet(object.updated))
      obj.updated = AbsoluteTxPosition.fromJSON(object.updated);
    if (isSet(object.msg)) obj.msg = bytesFromBase64(object.msg);
    return obj;
  },
  toJSON(
    message: ContractCodeHistoryEntry,
  ): JsonSafe<ContractCodeHistoryEntry> {
    const obj: any = {};
