...
export const InstantiateContractProposal = {
  ...
  toJSON(
    message: InstantiateContractProposal,
  ): JsonSafe<InstantiateContractProposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined &&
      (obj.description = message.description);
...
export const InstantiateContract2Proposal = {
  ...
  toJSON(
    message: InstantiateContract2Proposal,
  ): JsonSafe<InstantiateContract2Proposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined &&
      (obj.description = message.description);
...
export const UpdateInstantiateConfigProposal = {
  ...
  fromJSON(object: any): UpdateInstantiateConfigProposal {
    ...
    if (Array.isArray(object?.accessConfigUpdates))
      obj.accessConfigUpdates = object.accessConfigUpdates.map((e: any) =>
  ...
  toJSON(
    message: UpdateInstantiateConfigProposal,
  ): JsonSafe<UpdateInstantiateConfigProposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined &&
      (obj.description = message.description);
...
export const StoreAndInstantiateContractProposal = {
  ...
  toJSON(
    message: StoreAndInstantiateContractProposal,
  ): JsonSafe<StoreAndInstantiateContractProposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined &&
      (obj.description = message.description);
