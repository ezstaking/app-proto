...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.codes))
      obj.codes = object.codes.map((e: any) => Code.fromJSON(e));
...
export const Code = {
  ...
  fromJSON(object: any): Code {
    ...
    if (isSet(object.codeBytes))
      obj.codeBytes = bytesFromBase64(object.codeBytes);
...
export const Contract = {
  ...
  fromJSON(object: any): Contract {
    ...
    if (Array.isArray(object?.contractState))
      obj.contractState = object.contractState.map((e: any) =>
        Model.fromJSON(e),
      );
