...
export const StoreCodeAuthorization = {
  ...
  fromJSON(object: any): StoreCodeAuthorization {
    ...
    if (Array.isArray(object?.grants))
      obj.grants = object.grants.map((e: any) => CodeGrant.fromJSON(e));
    return obj;
  },
...
export const ContractExecutionAuthorization = {
  ...
  fromJSON(object: any): ContractExecutionAuthorization {
    ...
    if (Array.isArray(object?.grants))
      obj.grants = object.grants.map((e: any) => ContractGrant.fromJSON(e));
    return obj;
  },
  toJSON(
    message: ContractExecutionAuthorization,
  ): JsonSafe<ContractExecutionAuthorization> {
    const obj: any = {};
    if (message.grants) {
      obj.grants = message.grants.map((e) =>
...
export const ContractMigrationAuthorization = {
  ...
  toJSON(
    message: ContractMigrationAuthorization,
  ): JsonSafe<ContractMigrationAuthorization> {
    const obj: any = {};
    if (message.grants) {
      obj.grants = message.grants.map((e) =>
        e ? ContractGrant.toJSON(e) : undefined,
...
export const MaxCallsLimit = {
  ...
  toJSON(message: MaxCallsLimit): JsonSafe<MaxCallsLimit> {
    ...
    message.remaining !== undefined &&
      (obj.remaining = (message.remaining || BigInt(0)).toString());
    return obj;
  },
...
export const MaxFundsLimit = {
  ...
  fromJSON(object: any): MaxFundsLimit {
    ...
    if (Array.isArray(object?.amounts))
      obj.amounts = object.amounts.map((e: any) => Coin.fromJSON(e));
    return obj;
  },
...
export const CombinedLimit = {
  ...
  fromJSON(object: any): CombinedLimit {
    ...
    if (isSet(object.callsRemaining))
...
export const AcceptedMessageKeysFilter = {
  ...
  fromJSON(object: any): AcceptedMessageKeysFilter {
    ...
    if (Array.isArray(object?.keys))
      obj.keys = object.keys.map((e: any) => String(e));
    return obj;
  },
  toJSON(
    message: AcceptedMessageKeysFilter,
  ): JsonSafe<AcceptedMessageKeysFilter> {
    const obj: any = {};
    if (message.keys) {
...
export const AcceptedMessagesFilter = {
  ...
  fromJSON(object: any): AcceptedMessagesFilter {
    ...
    if (Array.isArray(object?.messages))
      obj.messages = object.messages.map((e: any) => bytesFromBase64(e));
    return obj;
  },
