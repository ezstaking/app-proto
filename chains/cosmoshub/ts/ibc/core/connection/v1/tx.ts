...
export const MsgConnectionOpenTry = {
  ...
  fromJSON(object: any): MsgConnectionOpenTry {
    ...
    if (isSet(object.clientId)) obj.clientId = String(object.clientId);
    if (isSet(object.previousConnectionId))
    ...
    if (Array.isArray(object?.counterpartyVersions))
      obj.counterpartyVersions = object.counterpartyVersions.map((e: any) =>
        Version.fromJSON(e),
      );
    ...
    if (isSet(object.proofClient))
      obj.proofClient = bytesFromBase64(object.proofClient);
    if (isSet(object.proofConsensus))
      obj.proofConsensus = bytesFromBase64(object.proofConsensus);
    if (isSet(object.consensusHeight))
      obj.consensusHeight = Height.fromJSON(object.consensusHeight);
    if (isSet(object.signer)) obj.signer = String(object.signer);
    if (isSet(object.hostConsensusStateProof))
      obj.hostConsensusStateProof = bytesFromBase64(
        object.hostConsensusStateProof,
      );
    return obj;
  },
