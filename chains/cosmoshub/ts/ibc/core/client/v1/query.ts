...
export const QueryClientStatesResponse = {
  ...
  fromJSON(object: any): QueryClientStatesResponse {
    ...
    if (Array.isArray(object?.clientStates))
      obj.clientStates = object.clientStates.map((e: any) =>
...
export const QueryConsensusStatesResponse = {
  ...
  fromJSON(object: any): QueryConsensusStatesResponse {
    ...
    if (Array.isArray(object?.consensusStates))
      obj.consensusStates = object.consensusStates.map((e: any) =>
...
export const QueryConsensusStateHeightsResponse = {
  ...
  fromJSON(object: any): QueryConsensusStateHeightsResponse {
    ...
    if (Array.isArray(object?.consensusStateHeights))
      obj.consensusStateHeights = object.consensusStateHeights.map((e: any) =>
        Height.fromJSON(e),
      );
    if (isSet(object.pagination))
      obj.pagination = PageResponse.fromJSON(object.pagination);
...
export const QueryVerifyMembershipRequest = {
  ...
  fromJSON(object: any): QueryVerifyMembershipRequest {
    ...
    if (isSet(object.proofHeight))
      obj.proofHeight = Height.fromJSON(object.proofHeight);
    if (isSet(object.merklePath))
      obj.merklePath = MerklePath.fromJSON(object.merklePath);
    if (isSet(object.value)) obj.value = bytesFromBase64(object.value);
    if (isSet(object.timeDelay))
      obj.timeDelay = BigInt(object.timeDelay.toString());
    if (isSet(object.blockDelay))
