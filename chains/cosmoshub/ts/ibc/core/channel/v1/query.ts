...
export const QueryChannelsResponse = {
  ...
  fromJSON(object: any): QueryChannelsResponse {
    ...
    if (Array.isArray(object?.channels))
      obj.channels = object.channels.map((e: any) =>
...
export const QueryChannelClientStateResponse = {
  ...
  fromJSON(object: any): QueryChannelClientStateResponse {
    ...
    if (isSet(object.identifiedClientState))
      obj.identifiedClientState = IdentifiedClientState.fromJSON(
...
export const QueryChannelConsensusStateRequest = {
  ...
  fromJSON(object: any): QueryChannelConsensusStateRequest {
    ...
    if (isSet(object.portId)) obj.portId = String(object.portId);
    if (isSet(object.channelId)) obj.channelId = String(object.channelId);
    if (isSet(object.revisionNumber))
      obj.revisionNumber = BigInt(object.revisionNumber.toString());
    if (isSet(object.revisionHeight))
...
export const QueryChannelConsensusStateResponse = {
  ...
  fromJSON(object: any): QueryChannelConsensusStateResponse {
    ...
    if (isSet(object.consensusState))
      obj.consensusState = Any.fromJSON(object.consensusState);
...
export const QueryPacketCommitmentResponse = {
  ...
  fromJSON(object: any): QueryPacketCommitmentResponse {
    ...
    if (isSet(object.commitment))
      obj.commitment = bytesFromBase64(object.commitment);
    if (isSet(object.proof)) obj.proof = bytesFromBase64(object.proof);
    if (isSet(object.proofHeight))
      obj.proofHeight = Height.fromJSON(object.proofHeight);
    return obj;
...
export const QueryPacketCommitmentsResponse = {
  ...
  fromJSON(object: any): QueryPacketCommitmentsResponse {
    ...
    if (Array.isArray(object?.commitments))
      obj.commitments = object.commitments.map((e: any) =>
...
export const QueryPacketAcknowledgementsRequest = {
  ...
  fromJSON(object: any): QueryPacketAcknowledgementsRequest {
    ...
    if (Array.isArray(object?.packetCommitmentSequences))
      obj.packetCommitmentSequences = object.packetCommitmentSequences.map(
        (e: any) => BigInt(e.toString()),
      );
    return obj;
  },
  toJSON(
...
export const QueryPacketAcknowledgementsResponse = {
  ...
  fromJSON(object: any): QueryPacketAcknowledgementsResponse {
    ...
    if (Array.isArray(object?.acknowledgements))
      obj.acknowledgements = object.acknowledgements.map((e: any) =>
        PacketState.fromJSON(e),
      );
    if (isSet(object.pagination))
      obj.pagination = PageResponse.fromJSON(object.pagination);
...
export const QueryUnreceivedAcksRequest = {
  ...
  fromJSON(object: any): QueryUnreceivedAcksRequest {
    ...
    if (Array.isArray(object?.packetAckSequences))
      obj.packetAckSequences = object.packetAckSequences.map((e: any) =>
        BigInt(e.toString()),
      );
    return obj;
  },
...
export const QueryNextSequenceReceiveResponse = {
  ...
  >(object: I): QueryNextSequenceReceiveResponse {
    ...
    if (
      ...
      message.nextSequenceReceive = BigInt(
        object.nextSequenceReceive.toString(),
      );
    }
    message.proof = object.proof ?? new Uint8Array();
    if (object.proofHeight !== undefined && object.proofHeight !== null) {
...
export const QueryNextSequenceSendResponse = {
  ...
  fromJSON(object: any): QueryNextSequenceSendResponse {
    ...
    if (isSet(object.nextSequenceSend))
...
export const QueryUpgradeRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryUpgradeRequest>, I>>(
    object: I,
  ): QueryUpgradeRequest {
    const message = createBaseQueryUpgradeRequest();
    message.portId = object.portId ?? "";
...
export const QueryUpgradeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryUpgradeResponse>, I>>(
    object: I,
  ): QueryUpgradeResponse {
    const message = createBaseQueryUpgradeResponse();
...
export const QueryChannelParamsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryChannelParamsRequest>, I>>(
    _: I,
  ): QueryChannelParamsRequest {
    const message = createBaseQueryChannelParamsRequest();
    return message;
