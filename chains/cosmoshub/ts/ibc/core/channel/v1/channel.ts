...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.upgradeTimeout))
      obj.upgradeTimeout = Timeout.fromJSON(object.upgradeTimeout);
    return obj;
  },
