...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.sendSequences))
      obj.sendSequences = object.sendSequences.map((e: any) =>
        PacketSequence.fromJSON(e),
      );
    if (Array.isArray(object?.recvSequences))
      obj.recvSequences = object.recvSequences.map((e: any) =>
        PacketSequence.fromJSON(e),
      );
    if (Array.isArray(object?.ackSequences))
      obj.ackSequences = object.ackSequences.map((e: any) =>
        PacketSequence.fromJSON(e),
      );
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      ...
      message.nextChannelSequence = BigInt(
        object.nextChannelSequence.toString(),
      );
    }
