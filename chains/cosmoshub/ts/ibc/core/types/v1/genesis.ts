...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.clientGenesis))
      obj.clientGenesis = GenesisState1.fromJSON(object.clientGenesis);
    if (isSet(object.connectionGenesis))
      obj.connectionGenesis = GenesisState2.fromJSON(object.connectionGenesis);
    if (isSet(object.channelGenesis))
      obj.channelGenesis = GenesisState3.fromJSON(object.channelGenesis);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      ...
      message.connectionGenesis = GenesisState2.fromPartial(
        object.connectionGenesis,
      );
    }
