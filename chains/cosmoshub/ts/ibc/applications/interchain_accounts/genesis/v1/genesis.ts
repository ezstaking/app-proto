...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (isSet(object.controllerGenesisState))
      obj.controllerGenesisState = ControllerGenesisState.fromJSON(
...
export const ControllerGenesisState = {
  ...
  fromJSON(object: any): ControllerGenesisState {
    ...
    if (Array.isArray(object?.activeChannels))
      obj.activeChannels = object.activeChannels.map((e: any) =>
    ...
    if (Array.isArray(object?.ports))
      obj.ports = object.ports.map((e: any) => String(e));
...
export const ActiveChannel = {
  ...
  fromJSON(object: any): ActiveChannel {
    ...
    if (isSet(object.isMiddlewareEnabled))
