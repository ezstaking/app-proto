...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.identifiedFees))
      obj.identifiedFees = object.identifiedFees.map((e: any) =>
    ...
    if (Array.isArray(object?.registeredPayees))
      obj.registeredPayees = object.registeredPayees.map((e: any) =>
    ...
    if (Array.isArray(object?.forwardRelayers))
      obj.forwardRelayers = object.forwardRelayers.map((e: any) =>
...
export const RegisteredCounterpartyPayee = {
  ...
  toJSON(
    message: RegisteredCounterpartyPayee,
  ): JsonSafe<RegisteredCounterpartyPayee> {
    const obj: any = {};
    message.channelId !== undefined && (obj.channelId = message.channelId);
    message.relayer !== undefined && (obj.relayer = message.relayer);
